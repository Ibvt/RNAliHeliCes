...
#ifndef mfe_microstate_hh
#define mfe_microstate_hh
...
t_0_right_most = t_0_seq.size();
  ...
  private:
    ...
    mfecovar edl(const TUSubsequence & ldangle, const mfecovar & x, const TUSubsequence & rb);
    mfecovar edlr(const TUSubsequence & ldangle, const mfecovar & x, const TUSubsequence & rdangle);
    mfecovar edr(const TUSubsequence & lb, const mfecovar & x, const TUSubsequence & rdangle);
    ...
    mfecovar mldl(const TUSubsequence & lb, const TUSubsequence & dl, const mfecovar & x, const TUSubsequence & rb);
    mfecovar mldlr(const TUSubsequence & lb, const TUSubsequence & dl, const mfecovar & x, const TUSubsequence & dr, const TUSubsequence & rb);
    mfecovar mldr(const TUSubsequence & lb, const mfecovar & x, const TUSubsequence & dr, const TUSubsequence & rb);
...
template <typename Value, typename pos_int>
struct Backtrace_edl : Backtrace_Score<mfecovar, Value, pos_int> {
      TUSubsequence arg_p_p_lb;
      intrusive_ptr<Backtrace<Value, pos_int> >  arg_p_p_e;
...
#line 1409 ""
      ...
      std::pair<std::pair<String, shape_t> , double>  edl(const TUSubsequence & p_p_lb, const std::pair<std::pair<String, shape_t> , double> & p_p_e, const TUSubsequence & p_p_loc)
      {
        TUSubsequence l_0 = p_p_lb;
        std::pair<String, shape_t>  l_1 = p_p_e.first;
      ...
      intrusive_ptr<Eval_List<Value> > eval()
      {
        ...
        if (!arg_p_p_e_t) {
          ...
          for (typename Eval_List<Value>::iterator arg_p_p_e_elem_itr = arg_p_p_e_elist->begin(); arg_p_p_e_elem_itr != arg_p_p_e_elist->end(); ++ arg_p_p_e_elem_itr) {
            std::pair<std::pair<String, shape_t> , double>  arg_p_p_e_elem = *arg_p_p_e_elem_itr;
            std::pair<std::pair<String, shape_t> , double>  ret = edl(arg_p_p_lb, arg_p_p_e_elem, arg_p_p_loc);
            push_back( answer, ret);
          }
          erase( arg_p_p_e_elist);
        } else 
...
template <typename Value, typename pos_int>
struct Backtrace_edlr : Backtrace_Score<mfecovar, Value, pos_int> {
      TUSubsequence arg_p_p_lb;
      intrusive_ptr<Backtrace<Value, pos_int> >  arg_p_p_e;
      TUSubsequence arg_p_p_rb;
...
#line 1532 ""
      ...
      std::pair<std::pair<String, shape_t> , double>  edlr(const TUSubsequence & p_p_lb, const std::pair<std::pair<String, shape_t> , double> & p_p_e, const TUSubsequence & p_p_rb)
      {
        TUSubsequence l_0 = p_p_lb;
        std::pair<String, shape_t>  l_1 = p_p_e.first;
      ...
      intrusive_ptr<Eval_List<Value> > eval()
      {
        ...
        if (!arg_p_p_e_t) {
          ...
          for (typename Eval_List<Value>::iterator arg_p_p_e_elem_itr = arg_p_p_e_elist->begin(); arg_p_p_e_elem_itr != arg_p_p_e_elist->end(); ++ arg_p_p_e_elem_itr) {
            std::pair<std::pair<String, shape_t> , double>  arg_p_p_e_elem = *arg_p_p_e_elem_itr;
            std::pair<std::pair<String, shape_t> , double>  ret = edlr(arg_p_p_lb, arg_p_p_e_elem, arg_p_p_rb);
            push_back( answer, ret);
          }
          erase( arg_p_p_e_elist);
        } else 
...
template <typename Value, typename pos_int>
struct Backtrace_edr : Backtrace_Score<mfecovar, Value, pos_int> {
      TUSubsequence arg_p_p_loc;
      intrusive_ptr<Backtrace<Value, pos_int> >  arg_p_p_e;
      TUSubsequence arg_p_p_rb;
...
#line 1652 ""
      ...
      std::pair<std::pair<String, shape_t> , double>  edr(const TUSubsequence & p_p_loc, const std::pair<std::pair<String, shape_t> , double> & p_p_e, const TUSubsequence & p_p_rb)
      {
      ...
      intrusive_ptr<Eval_List<Value> > eval()
      {
        ...
        if (!arg_p_p_e_t) {
          ...
          for (typename Eval_List<Value>::iterator arg_p_p_e_elem_itr = arg_p_p_e_elist->begin(); arg_p_p_e_elem_itr != arg_p_p_e_elist->end(); ++ arg_p_p_e_elem_itr) {
            std::pair<std::pair<String, shape_t> , double>  arg_p_p_e_elem = *arg_p_p_e_elem_itr;
            std::pair<std::pair<String, shape_t> , double>  ret = edr(arg_p_p_loc, arg_p_p_e_elem, arg_p_p_rb);
            push_back( answer, ret);
          }
          erase( arg_p_p_e_elist);
        } else 
...
template <typename Value, typename pos_int>
struct Backtrace_mldl : Backtrace_Score<mfecovar, Value, pos_int> {
      TUSubsequence arg_p_p_lb;
...
#line 2215 ""
      ...
      std::pair<std::pair<String, shape_t> , double>  mldl(const TUSubsequence & p_p_lb, const TUSubsequence & p_p_dl, const std::pair<std::pair<String, shape_t> , double> & p_p_e, const TUSubsequence & p_p_rb)
      {
        TUSubsequence l_0 = p_p_lb;
      ...
      intrusive_ptr<Eval_List<Value> > eval()
      {
        ...
        if (!arg_p_p_e_t) {
          ...
          for (typename Eval_List<Value>::iterator arg_p_p_e_elem_itr = arg_p_p_e_elist->begin(); arg_p_p_e_elem_itr != arg_p_p_e_elist->end(); ++ arg_p_p_e_elem_itr) {
            std::pair<std::pair<String, shape_t> , double>  arg_p_p_e_elem = *arg_p_p_e_elem_itr;
            std::pair<std::pair<String, shape_t> , double>  ret = mldl(arg_p_p_lb, arg_p_p_dl, arg_p_p_e_elem, arg_p_p_rb);
            push_back( answer, ret);
          }
          erase( arg_p_p_e_elist);
        } else 
...
template <typename Value, typename pos_int>
struct Backtrace_mldlr : Backtrace_Score<mfecovar, Value, pos_int> {
      TUSubsequence arg_p_p_lb;
      TUSubsequence arg_p_p_dl;
      intrusive_ptr<Backtrace<Value, pos_int> >  arg_p_p_e;
...
#line 2349 ""
      ...
      std::pair<std::pair<String, shape_t> , double>  mldlr(const TUSubsequence & p_p_lb, const TUSubsequence & p_p_dl, const std::pair<std::pair<String, shape_t> , double> & p_p_e, const TUSubsequence & p_p_dr, const TUSubsequence & p_p_rb)
      {
        TUSubsequence l_0 = p_p_lb;
        TUSubsequence l_1 = p_p_dl;
        std::pair<String, shape_t>  l_2 = p_p_e.first;
      ...
      intrusive_ptr<Eval_List<Value> > eval()
      {
        ...
        if (!arg_p_p_e_t) {
          ...
          for (typename Eval_List<Value>::iterator arg_p_p_e_elem_itr = arg_p_p_e_elist->begin(); arg_p_p_e_elem_itr != arg_p_p_e_elist->end(); ++ arg_p_p_e_elem_itr) {
            std::pair<std::pair<String, shape_t> , double>  arg_p_p_e_elem = *arg_p_p_e_elem_itr;
            std::pair<std::pair<String, shape_t> , double>  ret = mldlr(arg_p_p_lb, arg_p_p_dl, arg_p_p_e_elem, arg_p_p_dr, arg_p_p_rb);
            push_back( answer, ret);
          }
          erase( arg_p_p_e_elist);
        } else 
...
template <typename Value, typename pos_int>
struct Backtrace_mldr : Backtrace_Score<mfecovar, Value, pos_int> {
      TUSubsequence arg_p_p_lb;
      intrusive_ptr<Backtrace<Value, pos_int> >  arg_p_p_e;
      TUSubsequence arg_p_p_dr;
      TUSubsequence arg_p_p_rb;
...
#line 2476 ""
      ...
      std::pair<std::pair<String, shape_t> , double>  mldr(const TUSubsequence & p_p_lb, const std::pair<std::pair<String, shape_t> , double> & p_p_e, const TUSubsequence & p_p_dr, const TUSubsequence & p_p_rb)
      {
        TUSubsequence l_0 = p_p_lb;
        std::pair<String, shape_t>  l_1 = p_p_e.first;
      ...
      intrusive_ptr<Eval_List<Value> > eval()
      {
        ...
        if (!arg_p_p_e_t) {
          ...
          for (typename Eval_List<Value>::iterator arg_p_p_e_elem_itr = arg_p_p_e_elist->begin(); arg_p_p_e_elem_itr != arg_p_p_e_elist->end(); ++ arg_p_p_e_elem_itr) {
            std::pair<std::pair<String, shape_t> , double>  arg_p_p_e_elem = *arg_p_p_e_elem_itr;
            std::pair<std::pair<String, shape_t> , double>  ret = mldr(arg_p_p_lb, arg_p_p_e_elem, arg_p_p_dr, arg_p_p_rb);
            push_back( answer, ret);
          }
          erase( arg_p_p_e_elist);
        } else 
...
{
  intrusive_ptr<Backtrace_nt_struct_Back<mfe_microstate, Value, pos_int> > back;

Backtrace_nt_struct_Front(intrusive_ptr<Backtrace_nt_struct_Back<mfe_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, mfe_microstate, Value, pos_int> > t = back;
...
{
  intrusive_ptr<Backtrace_nt_dangle_Back<mfe_microstate, Value, pos_int> > back;

Backtrace_nt_dangle_Front(intrusive_ptr<Backtrace_nt_dangle_Back<mfe_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, mfe_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_strong_Back<mfe_microstate, Value, pos_int> > back;

Backtrace_nt_strong_Front(intrusive_ptr<Backtrace_nt_strong_Back<mfe_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, mfe_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_weak_Back<mfe_microstate, Value, pos_int> > back;

Backtrace_nt_weak_Front(intrusive_ptr<Backtrace_nt_weak_Back<mfe_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, mfe_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_stack_Back<mfe_microstate, Value, pos_int> > back;

Backtrace_nt_stack_Front(intrusive_ptr<Backtrace_nt_stack_Back<mfe_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, mfe_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_hairpin_Back<mfe_microstate, Value, pos_int> > back;

Backtrace_nt_hairpin_Front(intrusive_ptr<Backtrace_nt_hairpin_Back<mfe_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, mfe_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_leftB_Back<mfe_microstate, Value, pos_int> > back;

Backtrace_nt_leftB_Front(intrusive_ptr<Backtrace_nt_leftB_Back<mfe_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, mfe_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_rightB_Back<mfe_microstate, Value, pos_int> > back;

Backtrace_nt_rightB_Front(intrusive_ptr<Backtrace_nt_rightB_Back<mfe_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, mfe_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_iloop_Back<mfe_microstate, Value, pos_int> > back;

Backtrace_nt_iloop_Front(intrusive_ptr<Backtrace_nt_iloop_Back<mfe_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, mfe_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_multiloop_Back<mfe_microstate, Value, pos_int> > back;

Backtrace_nt_multiloop_Front(intrusive_ptr<Backtrace_nt_multiloop_Back<mfe_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, mfe_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_ml_comps_Back<mfe_microstate, Value, pos_int> > back;

Backtrace_nt_ml_comps_Front(intrusive_ptr<Backtrace_nt_ml_comps_Back<mfe_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, mfe_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_ml_comps1_Back<mfe_microstate, Value, pos_int> > back;

Backtrace_nt_ml_comps1_Front(intrusive_ptr<Backtrace_nt_ml_comps1_Back<mfe_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, mfe_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
intrusive_ptr<Eval_List<Value> > eval()
{
  ...
  return t->eval();
    ...
    intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  edl_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_1, const TUSubsequence & param_2);
    intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  edlr_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_1, const TUSubsequence & param_2);
    intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  edr_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_1, const TUSubsequence & param_2);
    ...
    intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mldl_bt_r(const TUSubsequence & param_0, const TUSubsequence & param_1, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_2, const TUSubsequence & param_3);
    intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mldlr_bt_r(const TUSubsequence & param_0, const TUSubsequence & param_1, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_2, const TUSubsequence & param_3, const TUSubsequence & param_4);
    intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mldr_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_1, const TUSubsequence & param_2, const TUSubsequence & param_3);
    ...
    std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  edl_bt(const TUSubsequence & p_ldangle, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_rb);
    std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  edlr_bt(const TUSubsequence & p_ldangle, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_rdangle);
    std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  edr_bt(const TUSubsequence & p_lb, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_rdangle);
    ...
    std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  mldl_bt(const TUSubsequence & p_lb, const TUSubsequence & p_dl, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_rb);
    std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  mldlr_bt(const TUSubsequence & p_lb, const TUSubsequence & p_dl, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_dr, const TUSubsequence & p_rb);
    std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  mldr_bt(const TUSubsequence & p_lb, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_dr, const TUSubsequence & p_rb);
...
namespace gapc {
  typedef mfe_microstate class_name;
