...
#ifndef subopt_overdangle_hh
#define subopt_overdangle_hh
...
List_Ref<mfecovar> LmfecovarM_zero;
...
unsigned int t_0_left_most;
unsigned int t_0_right_most;
std::vector<List_Ref<mfecovar> > array;
std::vector<bool> tabulated;
unsigned int t_0_n;
List_Ref<mfecovar> zero;
unsigned int size()
{
...
List_Ref<mfecovar> &  get(unsigned int t_0_i, unsigned int t_0_j)
{
  assert( (t_0_i <= t_0_j));
  assert( (t_0_j <= t_0_n));
  if (((t_0_j - t_0_i) < 5))
...
void set(unsigned int t_0_i, unsigned int t_0_j, List_Ref<mfecovar> e)
{
  assert( (t_0_i <= t_0_j));
  assert( (t_0_j <= t_0_n));
  if (((t_0_j - t_0_i) < 5))
...
void clear() { tabulated.clear(); }
List_Ref<mfecovar> &  get(unsigned int t_0_i)
{
  unsigned int t_0_j = t_0_n;
  assert( (t_0_i <= t_0_j));
  assert( (t_0_j <= t_0_n));
...
void set(unsigned int t_0_i, List_Ref<mfecovar> e)
{
  unsigned int t_0_j = t_0_n;
  assert( (t_0_i <= t_0_j));
  assert( (t_0_j <= t_0_n));
...
t_0_right_most = t_0_seq.size();
  ...
  private:
    List_Ref<mfecovar> &  nt_dangle(unsigned int t_0_i, unsigned int t_0_j);
    mfecovar nt_hairpin(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<mfecovar> &  nt_iloop(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<mfecovar> nt_leftB(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<mfecovar> &  nt_ml_comps(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<mfecovar> &  nt_ml_comps1(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<mfecovar> nt_multiloop(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<mfecovar> nt_rightB(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<mfecovar> nt_stack(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<mfecovar> &  nt_strong(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<mfecovar> &  nt_struct(unsigned int t_0_i);
    List_Ref<mfecovar> &  nt_weak(unsigned int t_0_i, unsigned int t_0_j);
    ...
    List_Ref<mfecovar> h(List_Ref<mfecovar> i);
template <typename Iterator>
    List_Ref<mfecovar> h(std::pair<Iterator, Iterator> i)
;
...
{
  intrusive_ptr<Backtrace_nt_struct_Back<subopt_overdangle, Value, pos_int> > back;

Backtrace_nt_struct_Front(intrusive_ptr<Backtrace_nt_struct_Back<subopt_overdangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_overdangle, Value, pos_int> > t = back;
...
{
  intrusive_ptr<Backtrace_nt_dangle_Back<subopt_overdangle, Value, pos_int> > back;

Backtrace_nt_dangle_Front(intrusive_ptr<Backtrace_nt_dangle_Back<subopt_overdangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_overdangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_strong_Back<subopt_overdangle, Value, pos_int> > back;

Backtrace_nt_strong_Front(intrusive_ptr<Backtrace_nt_strong_Back<subopt_overdangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_overdangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_weak_Back<subopt_overdangle, Value, pos_int> > back;

Backtrace_nt_weak_Front(intrusive_ptr<Backtrace_nt_weak_Back<subopt_overdangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_overdangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_stack_Back<subopt_overdangle, Value, pos_int> > back;

Backtrace_nt_stack_Front(intrusive_ptr<Backtrace_nt_stack_Back<subopt_overdangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_overdangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_hairpin_Back<subopt_overdangle, Value, pos_int> > back;

Backtrace_nt_hairpin_Front(intrusive_ptr<Backtrace_nt_hairpin_Back<subopt_overdangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_overdangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_leftB_Back<subopt_overdangle, Value, pos_int> > back;

Backtrace_nt_leftB_Front(intrusive_ptr<Backtrace_nt_leftB_Back<subopt_overdangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_overdangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_rightB_Back<subopt_overdangle, Value, pos_int> > back;

Backtrace_nt_rightB_Front(intrusive_ptr<Backtrace_nt_rightB_Back<subopt_overdangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_overdangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_iloop_Back<subopt_overdangle, Value, pos_int> > back;

Backtrace_nt_iloop_Front(intrusive_ptr<Backtrace_nt_iloop_Back<subopt_overdangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_overdangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_multiloop_Back<subopt_overdangle, Value, pos_int> > back;

Backtrace_nt_multiloop_Front(intrusive_ptr<Backtrace_nt_multiloop_Back<subopt_overdangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_overdangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_ml_comps_Back<subopt_overdangle, Value, pos_int> > back;

Backtrace_nt_ml_comps_Front(intrusive_ptr<Backtrace_nt_ml_comps_Back<subopt_overdangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_overdangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_ml_comps1_Back<subopt_overdangle, Value, pos_int> > back;

Backtrace_nt_ml_comps1_Front(intrusive_ptr<Backtrace_nt_ml_comps1_Back<subopt_overdangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_overdangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
intrusive_ptr<Eval_List<Value> > eval()
{
  ...
  return t->eval();
    ...
    List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > h_bt(List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > i, List_Ref<mfecovar> &  left_answers);
template <typename Iterator>
    List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > h_bt(std::pair<Iterator, Iterator> i, List_Ref<mfecovar> &  left_answers)
;
...
template <typename Iterator>
    List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > h_bt(std::pair<Iterator, Iterator> i)
;
...
{
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > bt  = bt_proxy_nt_struct(t_0_i);
...
namespace gapc {
  typedef subopt_overdangle class_name;
  typedef List_Ref<mfecovar> &  return_type;
}
#endif
