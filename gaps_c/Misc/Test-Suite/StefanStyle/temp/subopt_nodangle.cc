...
List_Ref<mfecovar> &  subopt_nodangle::nt_dangle(unsigned int t_0_i, unsigned int t_0_j)
{
...
mfecovar subopt_nodangle::nt_hairpin(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 5))
    {
...
List_Ref<mfecovar> &  subopt_nodangle::nt_iloop(unsigned int t_0_i, unsigned int t_0_j)
{
...
List_Ref<mfecovar> subopt_nodangle::nt_leftB(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 8))
    {
...
List_Ref<mfecovar> &  subopt_nodangle::nt_ml_comps(unsigned int t_0_i, unsigned int t_0_j)
{
...
List_Ref<mfecovar> &  subopt_nodangle::nt_ml_comps1(unsigned int t_0_i, unsigned int t_0_j)
{
...
List_Ref<mfecovar> subopt_nodangle::nt_multiloop(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 12))
    {
      return LmfecovarM_zero;
...
List_Ref<mfecovar> subopt_nodangle::nt_rightB(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 8))
    {
      return LmfecovarM_zero;
...
List_Ref<mfecovar> subopt_nodangle::nt_stack(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 7))
    {
      return LmfecovarM_zero;
...
List_Ref<mfecovar> &  subopt_nodangle::nt_strong(unsigned int t_0_i, unsigned int t_0_j)
{
...
List_Ref<mfecovar> &  subopt_nodangle::nt_struct(unsigned int t_0_i)
{
...
List_Ref<mfecovar> &  subopt_nodangle::nt_weak(unsigned int t_0_i, unsigned int t_0_j)
{
...
mfecovar subopt_nodangle::addss(const mfecovar & x, const TUSubsequence & r)
{
  mfecovar res = x;
...
mfecovar subopt_nodangle::bl(const TUSubsequence & lb, const TUSubsequence & lr, const mfecovar & x, const TUSubsequence & rb)
{
  mfecovar res = x;
...
mfecovar subopt_nodangle::br(const TUSubsequence & lb, const mfecovar & x, const TUSubsequence & rr, const TUSubsequence & rb)
{
  mfecovar res = x;
...
mfecovar subopt_nodangle::cadd(const mfecovar & x, const mfecovar & y)
{
#line 1542 "../../../../ali_nodangle.gap"
  return  ( (x + y) ) ;
#line 1029 "subopt_nodangle.cc"
}

mfecovar subopt_nodangle::drem(const TUSubsequence & lb, const mfecovar & x, const TUSubsequence & rb)
{
  mfecovar res = x;
...
List_Ref<mfecovar> subopt_nodangle::h(List_Ref<mfecovar> i)
{
...
List_Ref<mfecovar> subopt_nodangle::h(std::pair<Iterator, Iterator> i)

{
#line 1698 "../../../../ali_nodangle.gap"
  return mfeSuboptAli(i);
#line 1051 "subopt_nodangle.cc"
}

mfecovar subopt_nodangle::hl(const TUSubsequence & lb, const TUSubsequence & r, const TUSubsequence & rb)
{
  mfecovar res;
...
mfecovar subopt_nodangle::il(const TUSubsequence & lb, const TUSubsequence & lr, const mfecovar & x, const TUSubsequence & rr, const TUSubsequence & rb)
{
  mfecovar res = x;
...
mfecovar subopt_nodangle::incl(const mfecovar & x)
{
  mfecovar res = x;
...
mfecovar subopt_nodangle::ml(const TUSubsequence & lb, const mfecovar & x, const TUSubsequence & rb)
{
  mfecovar res = x;
...
mfecovar subopt_nodangle::nil(const TUSubsequence & n)
{
  mfecovar res;
  res.mfe = 0;
  res.covar = 0;
...
mfecovar subopt_nodangle::sadd(const TUSubsequence & lb, const mfecovar & x)
{
  mfecovar res = x;
  int sbase_sum = 0;
...
mfecovar subopt_nodangle::sr(const TUSubsequence & lb, const mfecovar & x, const TUSubsequence & rb)
{
  mfecovar res = x;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > subopt_nodangle::bt_proxy_nt_struct(unsigned int t_0_i)
{
  ...
  intrusive_ptr<Backtrace_nt_struct_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_struct_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i);
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > subopt_nodangle::bt_proxy_nt_dangle(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_dangle_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_dangle_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  for (List_Ref<mfecovar>::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    mfecovar elem = *elem_itr;
    std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > subopt_nodangle::bt_proxy_nt_strong(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_strong_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_strong_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  for (List_Ref<mfecovar>::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    mfecovar elem = *elem_itr;
    std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > subopt_nodangle::bt_proxy_nt_weak(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_weak_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_weak_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  for (List_Ref<mfecovar>::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    mfecovar elem = *elem_itr;
    std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > subopt_nodangle::bt_proxy_nt_stack(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_stack_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_stack_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  for (List_Ref<mfecovar>::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    mfecovar elem = *elem_itr;
    std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  subopt_nodangle::bt_proxy_nt_hairpin(unsigned int t_0_i, unsigned int t_0_j)
{
  ...
  intrusive_ptr<Backtrace_nt_hairpin_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_hairpin_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  l.first = ret;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > subopt_nodangle::bt_proxy_nt_leftB(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_leftB_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_leftB_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  for (List_Ref<mfecovar>::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    mfecovar elem = *elem_itr;
    std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > subopt_nodangle::bt_proxy_nt_rightB(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_rightB_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_rightB_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  for (List_Ref<mfecovar>::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    mfecovar elem = *elem_itr;
    std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > subopt_nodangle::bt_proxy_nt_iloop(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_iloop_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_iloop_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  for (List_Ref<mfecovar>::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    mfecovar elem = *elem_itr;
    std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > subopt_nodangle::bt_proxy_nt_multiloop(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_multiloop_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_multiloop_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  for (List_Ref<mfecovar>::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    mfecovar elem = *elem_itr;
    std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > subopt_nodangle::bt_proxy_nt_ml_comps(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_ml_comps_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_ml_comps_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  for (List_Ref<mfecovar>::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    mfecovar elem = *elem_itr;
    std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > subopt_nodangle::bt_proxy_nt_ml_comps1(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_ml_comps1_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_ml_comps1_Back<subopt_nodangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  for (List_Ref<mfecovar>::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    mfecovar elem = *elem_itr;
    std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::bt_nt_dangle(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!dangle_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::bt_nt_hairpin(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 5))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::bt_nt_iloop(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!iloop_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::bt_nt_leftB(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 8))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::bt_nt_ml_comps(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!ml_comps_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::bt_nt_ml_comps1(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!ml_comps1_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::bt_nt_multiloop(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 12))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::bt_nt_rightB(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 8))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::bt_nt_stack(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 7))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::bt_nt_strong(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!strong_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::bt_nt_struct(unsigned int t_0_i)
{
  if (!struct_table.is_tabulated(t_0_i))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::bt_nt_weak(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!weak_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::addss_bt_r(intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_0, const TUSubsequence & param_1)
{
  return new Backtrace_addss<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::bl_bt_r(const TUSubsequence & param_0, const TUSubsequence & param_1, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_2, const TUSubsequence & param_3)
{
  return new Backtrace_bl<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1, param_2, param_3);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::br_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_1, const TUSubsequence & param_2, const TUSubsequence & param_3)
{
  return new Backtrace_br<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1, param_2, param_3);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::cadd_bt_r(intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_0, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_1)
{
  return new Backtrace_cadd<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::drem_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_1, const TUSubsequence & param_2)
{
  return new Backtrace_drem<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1, param_2);
}

List_Ref<intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > subopt_nodangle::h_bt_r(List_Ref<intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > param_0)
{
  return param_0;
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::hl_bt_r(const TUSubsequence & param_0, const TUSubsequence & param_1, const TUSubsequence & param_2)
{
  return new Backtrace_hl<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1, param_2);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::il_bt_r(const TUSubsequence & param_0, const TUSubsequence & param_1, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_2, const TUSubsequence & param_3, const TUSubsequence & param_4)
{
  return new Backtrace_il<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1, param_2, param_3, param_4);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::incl_bt_r(intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_0)
{
  return new Backtrace_incl<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::ml_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_1, const TUSubsequence & param_2)
{
  return new Backtrace_ml<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1, param_2);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::nil_bt_r(const TUSubsequence & param_0)
{
  return new Backtrace_nil<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::sadd_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_1)
{
  return new Backtrace_sadd<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  subopt_nodangle::sr_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_1, const TUSubsequence & param_2)
{
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  subopt_nodangle::addss_bt(const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_r)
{
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  subopt_nodangle::bl_bt(const TUSubsequence & p_lb, const TUSubsequence & p_lr, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_rb)
{
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  subopt_nodangle::br_bt(const TUSubsequence & p_lb, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_rr, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  subopt_nodangle::drem_bt(const TUSubsequence & p_lb, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  mfecovar l_1 = p_x.first;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > subopt_nodangle::h_bt(List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > i, List_Ref<mfecovar> &  left_answers)
{
...
template <typename Iterator>
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > subopt_nodangle::h_bt(std::pair<Iterator, Iterator> i, List_Ref<mfecovar> &  left_answers)
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > subopt_nodangle::h_bt(List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > i)
{
  std::pair<List<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > >::iterator, List<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > >::iterator> range = get_range(i);
  return h_bt(range);
}
...
template <typename Iterator>
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > subopt_nodangle::h_bt(std::pair<Iterator, Iterator> i)
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  subopt_nodangle::hl_bt(const TUSubsequence & p_lb, const TUSubsequence & p_r, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  TUSubsequence l_1 = p_r;
  TUSubsequence l_2 = p_rb;
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  subopt_nodangle::il_bt(const TUSubsequence & p_lb, const TUSubsequence & p_lr, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_rr, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  TUSubsequence l_1 = p_lr;
  mfecovar l_2 = p_x.first;
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  subopt_nodangle::incl_bt(const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x)
{
  mfecovar l_0 = p_x.first;
  intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  r_0 = p_x.second;
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  subopt_nodangle::ml_bt(const TUSubsequence & p_lb, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  mfecovar l_1 = p_x.first;
  TUSubsequence l_2 = p_rb;
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  subopt_nodangle::nil_bt(const TUSubsequence & p_n)
{
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  subopt_nodangle::sadd_bt(const TUSubsequence & p_lb, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x)
{
  TUSubsequence l_0 = p_lb;
  mfecovar l_1 = p_x.first;
  TUSubsequence r_0 = p_lb;
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  subopt_nodangle::sr_bt(const TUSubsequence & p_lb, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  mfecovar l_1 = p_x.first;
  TUSubsequence l_2 = p_rb;
