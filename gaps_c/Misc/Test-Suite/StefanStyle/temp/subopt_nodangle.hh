...
#ifndef subopt_nodangle_hh
#define subopt_nodangle_hh
...
{
  intrusive_ptr<Backtrace_nt_struct_Back<subopt_nodangle, Value, pos_int> > back;

Backtrace_nt_struct_Front(intrusive_ptr<Backtrace_nt_struct_Back<subopt_nodangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_nodangle, Value, pos_int> > t = back;
...
{
  intrusive_ptr<Backtrace_nt_dangle_Back<subopt_nodangle, Value, pos_int> > back;

Backtrace_nt_dangle_Front(intrusive_ptr<Backtrace_nt_dangle_Back<subopt_nodangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_nodangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_strong_Back<subopt_nodangle, Value, pos_int> > back;

Backtrace_nt_strong_Front(intrusive_ptr<Backtrace_nt_strong_Back<subopt_nodangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_nodangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_weak_Back<subopt_nodangle, Value, pos_int> > back;

Backtrace_nt_weak_Front(intrusive_ptr<Backtrace_nt_weak_Back<subopt_nodangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_nodangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_stack_Back<subopt_nodangle, Value, pos_int> > back;

Backtrace_nt_stack_Front(intrusive_ptr<Backtrace_nt_stack_Back<subopt_nodangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_nodangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_hairpin_Back<subopt_nodangle, Value, pos_int> > back;

Backtrace_nt_hairpin_Front(intrusive_ptr<Backtrace_nt_hairpin_Back<subopt_nodangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_nodangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_leftB_Back<subopt_nodangle, Value, pos_int> > back;

Backtrace_nt_leftB_Front(intrusive_ptr<Backtrace_nt_leftB_Back<subopt_nodangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_nodangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_rightB_Back<subopt_nodangle, Value, pos_int> > back;

Backtrace_nt_rightB_Front(intrusive_ptr<Backtrace_nt_rightB_Back<subopt_nodangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_nodangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_iloop_Back<subopt_nodangle, Value, pos_int> > back;

Backtrace_nt_iloop_Front(intrusive_ptr<Backtrace_nt_iloop_Back<subopt_nodangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_nodangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_multiloop_Back<subopt_nodangle, Value, pos_int> > back;

Backtrace_nt_multiloop_Front(intrusive_ptr<Backtrace_nt_multiloop_Back<subopt_nodangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_nodangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_ml_comps_Back<subopt_nodangle, Value, pos_int> > back;

Backtrace_nt_ml_comps_Front(intrusive_ptr<Backtrace_nt_ml_comps_Back<subopt_nodangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_nodangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_ml_comps1_Back<subopt_nodangle, Value, pos_int> > back;

Backtrace_nt_ml_comps1_Front(intrusive_ptr<Backtrace_nt_ml_comps1_Back<subopt_nodangle, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<mfecovar, subopt_nodangle, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
namespace gapc {
  typedef subopt_nodangle class_name;
