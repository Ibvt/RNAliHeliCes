...
mfecovar &  mfe_overdangle::nt_dangle(unsigned int t_0_i, unsigned int t_0_j)
{
...
mfecovar mfe_overdangle::nt_hairpin(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 5))
    {
...
mfecovar &  mfe_overdangle::nt_iloop(unsigned int t_0_i, unsigned int t_0_j)
{
...
mfecovar mfe_overdangle::nt_leftB(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 8))
    {
      return mfecovar_zero;
...
mfecovar &  mfe_overdangle::nt_ml_comps(unsigned int t_0_i, unsigned int t_0_j)
{
...
mfecovar &  mfe_overdangle::nt_ml_comps1(unsigned int t_0_i, unsigned int t_0_j)
{
...
mfecovar mfe_overdangle::nt_multiloop(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 12))
    {
      return mfecovar_zero;
...
mfecovar mfe_overdangle::nt_rightB(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 8))
    {
      return mfecovar_zero;
...
mfecovar mfe_overdangle::nt_stack(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 7))
    {
      return mfecovar_zero;
...
mfecovar &  mfe_overdangle::nt_strong(unsigned int t_0_i, unsigned int t_0_j)
{
...
mfecovar &  mfe_overdangle::nt_struct(unsigned int t_0_i)
{
...
mfecovar &  mfe_overdangle::nt_weak(unsigned int t_0_i, unsigned int t_0_j)
{
...
mfecovar mfe_overdangle::addss(const mfecovar & x, const TUSubsequence & r)
{
  mfecovar res = x;
...
mfecovar mfe_overdangle::bl(const TUSubsequence & lb, const TUSubsequence & lr, const mfecovar & x, const TUSubsequence & rb)
{
  mfecovar res = x;
...
mfecovar mfe_overdangle::br(const TUSubsequence & lb, const mfecovar & x, const TUSubsequence & rr, const TUSubsequence & rb)
{
  mfecovar res = x;
...
mfecovar mfe_overdangle::cadd(const mfecovar & x, const mfecovar & y)
{
#line 1438 "../../../../ali_overdangle.gap"
  return  ( (x + y) ) ;
#line 1173 "mfe_overdangle.cc"
}

mfecovar mfe_overdangle::drem(const TUSubsequence & lb, const mfecovar & x, const TUSubsequence & rb)
{
#line 1600 "../../../../ali_overdangle.gap"
  mfecovar res = x;
  res.mfe = (x.mfe +  ( ( ( (termau_energy(lb, rb) + ext_mismatch_energy(lb, rb)) )  / float(rows(lb))) ) );
  res.covar = x.covar;
  return res;
#line 1183 "mfe_overdangle.cc"
}

mfecovar mfe_overdangle::h(mfecovar i)
{
  return i;
  return minimum(i);
}

mfecovar mfe_overdangle::hl(const TUSubsequence & lb, const TUSubsequence & r, const TUSubsequence & rb)
{
  mfecovar res;
...
mfecovar mfe_overdangle::il(const TUSubsequence & lb, const TUSubsequence & lr, const mfecovar & x, const TUSubsequence & rr, const TUSubsequence & rb)
{
  mfecovar res = x;
...
mfecovar mfe_overdangle::incl(const mfecovar & x)
{
  mfecovar res = x;
...
mfecovar mfe_overdangle::ml(const TUSubsequence & lb, const mfecovar & x, const TUSubsequence & rb)
{
#line 1606 "../../../../ali_overdangle.gap"
  mfecovar res = x;
  ...
  return res;
#line 1222 "mfe_overdangle.cc"
}

mfecovar mfe_overdangle::nil(const TUSubsequence & n)
{
  mfecovar res;
  res.mfe = 0;
  res.covar = 0;
...
mfecovar mfe_overdangle::sadd(const TUSubsequence & lb, const mfecovar & x)
{
  mfecovar res = x;
  int sbase_sum = 0;
...
mfecovar mfe_overdangle::sr(const TUSubsequence & lb, const mfecovar & x, const TUSubsequence & rb)
{
  mfecovar res = x;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > mfe_overdangle::bt_proxy_nt_struct(unsigned int t_0_i)
{
  ...
  intrusive_ptr<Backtrace_nt_struct_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_struct_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i);
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > mfe_overdangle::bt_proxy_nt_dangle(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_dangle_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_dangle_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
  tupel.first = ret;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > mfe_overdangle::bt_proxy_nt_strong(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_strong_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_strong_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
  tupel.first = ret;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > mfe_overdangle::bt_proxy_nt_weak(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_weak_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_weak_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
  tupel.first = ret;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > mfe_overdangle::bt_proxy_nt_stack(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_stack_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_stack_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
  tupel.first = ret;
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  mfe_overdangle::bt_proxy_nt_hairpin(unsigned int t_0_i, unsigned int t_0_j)
{
  ...
  intrusive_ptr<Backtrace_nt_hairpin_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_hairpin_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  l.first = ret;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > mfe_overdangle::bt_proxy_nt_leftB(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_leftB_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_leftB_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
  tupel.first = ret;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > mfe_overdangle::bt_proxy_nt_rightB(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_rightB_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_rightB_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
  tupel.first = ret;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > mfe_overdangle::bt_proxy_nt_iloop(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_iloop_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_iloop_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
  tupel.first = ret;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > mfe_overdangle::bt_proxy_nt_multiloop(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_multiloop_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_multiloop_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
  tupel.first = ret;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > mfe_overdangle::bt_proxy_nt_ml_comps(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_ml_comps_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_ml_comps_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
  tupel.first = ret;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > mfe_overdangle::bt_proxy_nt_ml_comps1(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > l;
  empty(l);
  ...
  intrusive_ptr<Backtrace_nt_ml_comps1_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int>  >  bt = new Backtrace_nt_ml_comps1_Back<mfe_overdangle, std::pair<std::pair<String, Shape> , double> , unsigned int> (this, t_0_i, t_0_j);
  std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  tupel;
  tupel.first = ret;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::bt_nt_dangle(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!dangle_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::bt_nt_hairpin(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 5))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::bt_nt_iloop(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!iloop_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::bt_nt_leftB(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 8))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::bt_nt_ml_comps(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!ml_comps_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::bt_nt_ml_comps1(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!ml_comps1_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::bt_nt_multiloop(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 12))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::bt_nt_rightB(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 8))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::bt_nt_stack(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 7))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::bt_nt_strong(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!strong_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::bt_nt_struct(unsigned int t_0_i)
{
  if (!struct_table.is_tabulated(t_0_i))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::bt_nt_weak(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!weak_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::addss_bt_r(intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_0, const TUSubsequence & param_1)
{
  return new Backtrace_addss<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::bl_bt_r(const TUSubsequence & param_0, const TUSubsequence & param_1, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_2, const TUSubsequence & param_3)
{
  return new Backtrace_bl<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1, param_2, param_3);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::br_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_1, const TUSubsequence & param_2, const TUSubsequence & param_3)
{
  return new Backtrace_br<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1, param_2, param_3);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::cadd_bt_r(intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_0, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_1)
{
  return new Backtrace_cadd<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::drem_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_1, const TUSubsequence & param_2)
{
  return new Backtrace_drem<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1, param_2);
}

List_Ref<intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > mfe_overdangle::h_bt_r(List_Ref<intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > param_0)
{
  return param_0;
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::hl_bt_r(const TUSubsequence & param_0, const TUSubsequence & param_1, const TUSubsequence & param_2)
{
  return new Backtrace_hl<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1, param_2);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::il_bt_r(const TUSubsequence & param_0, const TUSubsequence & param_1, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_2, const TUSubsequence & param_3, const TUSubsequence & param_4)
{
  return new Backtrace_il<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1, param_2, param_3, param_4);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::incl_bt_r(intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_0)
{
  return new Backtrace_incl<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::ml_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_1, const TUSubsequence & param_2)
{
  return new Backtrace_ml<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1, param_2);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::nil_bt_r(const TUSubsequence & param_0)
{
  return new Backtrace_nil<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::sadd_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_1)
{
  return new Backtrace_sadd<std::pair<std::pair<String, Shape> , double> , unsigned int> (param_0, param_1);
}

intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  mfe_overdangle::sr_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  param_1, const TUSubsequence & param_2)
{
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  mfe_overdangle::addss_bt(const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_r)
{
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  mfe_overdangle::bl_bt(const TUSubsequence & p_lb, const TUSubsequence & p_lr, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_rb)
{
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  mfe_overdangle::br_bt(const TUSubsequence & p_lb, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_rr, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  mfe_overdangle::drem_bt(const TUSubsequence & p_lb, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  mfecovar l_1 = p_x.first;
...
List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > mfe_overdangle::h_bt(List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > i, mfecovar &  left)
{
  return i;
}

List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > mfe_overdangle::h_bt(List_Ref<std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > > i)
{
  return i;
}

std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  mfe_overdangle::hl_bt(const TUSubsequence & p_lb, const TUSubsequence & p_r, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  TUSubsequence l_1 = p_r;
  TUSubsequence l_2 = p_rb;
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  mfe_overdangle::il_bt(const TUSubsequence & p_lb, const TUSubsequence & p_lr, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_rr, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  TUSubsequence l_1 = p_lr;
  mfecovar l_2 = p_x.first;
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  mfe_overdangle::incl_bt(const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x)
{
  mfecovar l_0 = p_x.first;
  intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> >  r_0 = p_x.second;
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  mfe_overdangle::ml_bt(const TUSubsequence & p_lb, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  mfecovar l_1 = p_x.first;
  TUSubsequence l_2 = p_rb;
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  mfe_overdangle::nil_bt(const TUSubsequence & p_n)
{
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  mfe_overdangle::sadd_bt(const TUSubsequence & p_lb, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x)
{
  TUSubsequence l_0 = p_lb;
  mfecovar l_1 = p_x.first;
  TUSubsequence r_0 = p_lb;
...
std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > >  mfe_overdangle::sr_bt(const TUSubsequence & p_lb, const std::pair<mfecovar, intrusive_ptr<Backtrace<std::pair<std::pair<String, Shape> , double> , unsigned int> > > & p_x, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  mfecovar l_1 = p_x.first;
  TUSubsequence l_2 = p_rb;
