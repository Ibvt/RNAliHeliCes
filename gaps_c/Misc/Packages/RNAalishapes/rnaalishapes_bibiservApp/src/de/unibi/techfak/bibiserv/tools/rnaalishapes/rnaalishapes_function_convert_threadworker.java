 ...
 */
/**
 * Implementation class  for function rnaalishapes_function_convert_threadworker, implements all request and
 * response methods ...
 *
...
public class rnaalishapes_function_convert_threadworker {


private String fct_id = "rnaalishapes_function_convert";


private static Logger log = Logger.getLogger(rnaalishapes_function_convert_threadworker.class);
...
if (input_0 instanceof AWSValidationConnection) {
	...
	postfix += bibitools.parseInputURL("rnaalishapes_input_rna_secondary_structure",inputhash, connection.getUrl(), generatedInfo, validatorImpl_0, converterChain_0, (representation_0.getContent()!=null) ? representation_0.getContent().name() : "NULL" , (representation_0.getStrictness()!=null) ? representation_0.getStrictness().name() : "NULL" , (representation_0.getCardinality()!=null) ? representation_0.getCardinality().name() : "NULL" , representation_0.getStructure().equals(datastructure.ALIGNMENT) || representation_0.getStructure().equals(datastructure.STRUCTUREALIGNMENT), streamsSupported_0);
} else {
	postfix += bibitools.parseInput("rnaalishapes_input_rna_secondary_structure",inputhash, input_0, representation_0.getType().name(), representation_0.getImplementationType());
}
