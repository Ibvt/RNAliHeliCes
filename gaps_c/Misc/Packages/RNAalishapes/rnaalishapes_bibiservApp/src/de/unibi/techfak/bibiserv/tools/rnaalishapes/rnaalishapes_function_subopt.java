 ...
 */
/**
 * Implementation class  for function rnaalishapes_function_subopt, implements all request and
 * response methods ...
 *
...
public class rnaalishapes_function_subopt {

private BiBiTools bibitools;
private Utilities utilities = new Utilities();


private static Logger log = Logger.getLogger(rnaalishapes_function_subopt.class);

    /* #########################################
     * #     DI method setExecfunction          #
     * ######################################### */
    public rnaalishapes_function_subopt_threadworker threadworker;

    public void setThreadworker(rnaalishapes_function_subopt_threadworker threadworker){
...
private String requestImpl( List<Pair<String,String>> paramlist,  String accesskey,  String secretkey,  String uploadbucket,  String uploadfolder, Object input_0, OntoRepresentation representation_0, boolean streamsSupported_0, boolean skipValidation_0) throws BiBiToolsException {
    ...
    private File getOutputFile() throws BiBiToolsException, DBConnectionException, IdNotFoundException{
        return bibitools.getOutputFile("rnaalishapes_function_subopt");
    }
