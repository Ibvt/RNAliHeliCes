...
import de.unibi.techfak.bibiserv.tools.rnaalishapes.rnaalishapes_function_subopt;
...
/**
 * This is a autogenerated bean controller template class for function <i>rnaalishapes_function_subopt_controller</i>
 *
 * @author Daniel Hagemeier - dhagemei[aet]cebitec.uni-bielefeld.de
 *         Armin Toepfer - atoepfer[aet]cebitec.uni-bielefeld.de
 *         Jan Krueger - jkrueger[aet]cebitec.uni-bielefeld.de
 */
public class rnaalishapes_function_subopt_controller implements InitializingBean, DisposableBean {

    private final static Logger log = Logger.getLogger(de.unibi.techfak.bibiserv.tools.rnaalishapes.web.rnaalishapes_function_subopt_controller.class);
     ...
     * #     DI method setParam                 #
     * ######################################### */
    public rnaalishapes_function_subopt_param param;

    public void setParam(rnaalishapes_function_subopt_param param) {
        this.param = param;
    }
     ...
     * #     DI method setResult               #
     * ######################################### */
    public rnaalishapes_function_subopt_result result;

    public void setResult(rnaalishapes_function_subopt_result result) {
        this.result = result;
    }
     ...
     * ######################################### */
    public rnaalishapes_function_subopt_resulthandler resulthandler;

    public void setResulthandler(rnaalishapes_function_subopt_resulthandler resulthandler) {
     ...
     * ######################################### */
    public rnaalishapes_function_subopt execfunction;

    public void setExecfunction(rnaalishapes_function_subopt execfunction) {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        // get DependencyTree
        dptree = pdp.getDependencyTree("rnaalishapes_function_subopt", parameterwrapper);
    }
   ...
   /* ###############################################################################
    ...
    public void calculate(ActionEvent e) {
        ...
        try {
            ...
            FacesContext.getCurrentInstance().getExternalContext().redirect("/rnaalishapes?viewType=submission&subType=rnaalishapes_function_subopt_result");
    ...
    public void paramSet(ActionEvent e) {
        ...
        try {
            if (dptree.evaluate()) {
                ...
                FacesContext.getCurrentInstance().getExternalContext().redirect("/rnaalishapes?viewType=submission&subType=rnaalishapes_function_subopt_p_3");
                ...
                for (Id id : chm.keySet()) {
                    ...
                    if (constraints == null || constraints.isEmpty()) {
                        param.addFaultmsg(id.getId()+"_rnaalishapes_function_subopt","Parameter '"+id.getId()+"' is mandantory !");
                    } else {
                        ...
                        param.addFaultmsg(id.getId()+"_rnaalishapes_function_subopt",sb.toString());
                    }
                }
            }
    ...
    public int getExampleCount(){             
        return tooldescription.getFunction("rnaalishapes_function_subopt").getExample().size();
    }
    ...
    public void example(int i) {
       Texample te = tooldescription.getFunction("rnaalishapes_function_subopt").getExample().get(i);
     ...
     public String exampleName(int i) {
        return tooldescription.getFunction("rnaalishapes_function_subopt").getExample().get(i).getName().get(0).getValue();
    }
