...
/**
 * This is a autogenerated bean input template class for function <i>rnaalishapes_function_eval_param</i>
 *
 ...
 */
 public class rnaalishapes_function_eval_param   { 

     private final static Logger log = Logger.getLogger(rnaalishapes_function_eval_param.class);
...
faultmsg.remove("rnaalishapes_parameter_structure_conservation_index_rnaalishapes_function_eval");
valid_rnaalishapes_parameter_structure_conservation_index = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_structure_conservation_index_rnaalishapes_function_eval",e.getMessage());}
...
faultmsg.remove("rnaalishapes_parameter_consensus_rnaalishapes_function_eval");
valid_rnaalishapes_parameter_consensus = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_consensus_rnaalishapes_function_eval",e.getMessage());}
...
faultmsg.remove("rnaalishapes_parameter_pairing_fraction_rnaalishapes_function_eval");
valid_rnaalishapes_parameter_pairing_fraction = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_pairing_fraction_rnaalishapes_function_eval",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.INTEGER"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_pairing_fraction_rnaalishapes_function_eval",e.getMessage());
}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_cfactor_rnaalishapes_function_eval");
valid_rnaalishapes_parameter_cfactor = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_cfactor_rnaalishapes_function_eval",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.FLOAT"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_cfactor_rnaalishapes_function_eval",e.getMessage());
}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_nfactor_rnaalishapes_function_eval");
valid_rnaalishapes_parameter_nfactor = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_nfactor_rnaalishapes_function_eval",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.FLOAT"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_nfactor_rnaalishapes_function_eval",e.getMessage());
}
...
faultmsg.remove("rnaalishapes_parameter_grammar_rnaalishapes_function_eval");
valid_rnaalishapes_parameter_grammar = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_grammar_rnaalishapes_function_eval",e.getMessage());}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_shape_level_rnaalishapes_function_eval");
valid_rnaalishapes_parameter_shape_level = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_shape_level_rnaalishapes_function_eval",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.INTEGER"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_shape_level_rnaalishapes_function_eval",e.getMessage());
}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_temperature_rnaalishapes_function_eval");
valid_rnaalishapes_parameter_temperature = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_temperature_rnaalishapes_function_eval",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.FLOAT"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_temperature_rnaalishapes_function_eval",e.getMessage());
}
...
faultmsg.remove("rnaalishapes_parameter_thermodynamic_model_parameters_rnaalishapes_function_eval");
valid_rnaalishapes_parameter_thermodynamic_model_parameters = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_thermodynamic_model_parameters_rnaalishapes_function_eval",e.getMessage());}
...
faultmsg.remove("rnaalishapes_parameter_lonely_base_pairs_rnaalishapes_function_eval");
valid_rnaalishapes_parameter_lonely_base_pairs = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_lonely_base_pairs_rnaalishapes_function_eval",e.getMessage());}
