...
/**
 * This is a autogenerated bean input template class for function <i>rnaalishapes_function_sample_param</i>
 *
 ...
 */
 public class rnaalishapes_function_sample_param   { 

     private final static Logger log = Logger.getLogger(rnaalishapes_function_sample_param.class);
     ...
     * ######################################### */
    private static final String defaultValue_rnaalishapes_parameter_numsamples="1000";
private static final String defaultValue_rnaalishapes_parameter_show_samples="0";
private static final String defaultValue_rnaalishapes_parameter_output_probability_filter="0.000001";
private static final String defaultValue_rnaalishapes_parameter_decimals_for_probabilities="7";
...
public void reset(){
rnaalishapes_parameter_numsamples = defaultValue_rnaalishapes_parameter_numsamples;
rnaalishapes_parameter_output_probability_filter = defaultValue_rnaalishapes_parameter_output_probability_filter;
rnaalishapes_parameter_decimals_for_probabilities = defaultValue_rnaalishapes_parameter_decimals_for_probabilities;
...
if (true 
&& rnaalishapes_parameter_numsamples.equals(defaultValue_rnaalishapes_parameter_numsamples)
&& rnaalishapes_parameter_output_probability_filter.equals(defaultValue_rnaalishapes_parameter_output_probability_filter)
&& rnaalishapes_parameter_decimals_for_probabilities.equals(defaultValue_rnaalishapes_parameter_decimals_for_probabilities)
...
return true;
     ...
     * ######################################### */
     public boolean isValid(){
        return true
                ...
                && valid_rnaalishapes_parameter_numsamples
                
                && valid_rnaalishapes_parameter_show_samples
                
                && valid_rnaalishapes_parameter_output_probability_filter
                
                && valid_rnaalishapes_parameter_decimals_for_probabilities
    ...
    public boolean checkAndSet(Prop p) {
        ...
        if (p.getIdref().equals("rnaalishapes_parameter_numsamples")) {
            rnaalishapes_parameter_numsamples = p.getValue();
            return true;
        }
        
        if (p.getIdref().equals("rnaalishapes_parameter_show_samples")) {
            rnaalishapes_parameter_show_samples = p.getValue();
            return true;
        }
        
        if (p.getIdref().equals("rnaalishapes_parameter_output_probability_filter")) {
            rnaalishapes_parameter_output_probability_filter = p.getValue();
            return true;
        }
        
        if (p.getIdref().equals("rnaalishapes_parameter_decimals_for_probabilities")) {
            rnaalishapes_parameter_decimals_for_probabilities = p.getValue();
            return true;
        }
    ...
    public List<Pair<String, String>> getParameterList() {
        ...
        if (!rnaalishapes_parameter_numsamples.isEmpty()) {
            pairlist.add(new Pair<String, String>("rnaalishapes_parameter_numsamples", rnaalishapes_parameter_numsamples));
        }
        
        if (!rnaalishapes_parameter_show_samples.isEmpty()) {
            pairlist.add(new Pair<String, String>("rnaalishapes_parameter_show_samples", rnaalishapes_parameter_show_samples));
        }
        
        if (!rnaalishapes_parameter_output_probability_filter.isEmpty()) {
            pairlist.add(new Pair<String, String>("rnaalishapes_parameter_output_probability_filter", rnaalishapes_parameter_output_probability_filter));
        }
        
        if (!rnaalishapes_parameter_decimals_for_probabilities.isEmpty()) {
            pairlist.add(new Pair<String, String>("rnaalishapes_parameter_decimals_for_probabilities", rnaalishapes_parameter_decimals_for_probabilities));
        }
     ...
     * ######################################### */
     /*--- parameter 'rnaalishapes_parameter_numsamples' --- */private boolean help_rnaalishapes_parameter_numsamples = false;public boolean isHelp_rnaalishapes_parameter_numsamples(){ return help_rnaalishapes_parameter_numsamples;}public void helpAction_rnaalishapes_parameter_numsamples(ActionEvent e){help_rnaalishapes_parameter_numsamples = !help_rnaalishapes_parameter_numsamples;}private String rnaalishapes_parameter_numsamples = defaultValue_rnaalishapes_parameter_numsamples;
private boolean valid_rnaalishapes_parameter_numsamples = true;
public String getRnaalishapes_parameter_numsamples(){return rnaalishapes_parameter_numsamples;}public void setRnaalishapes_parameter_numsamples(String input){
if (!rnaalishapes_parameter_numsamples.equals(input)) {
this.rnaalishapes_parameter_numsamples=input;
try {
if (!input.isEmpty()) {
int tmp =  Integer.parseInt(input);
Utilities.validate_rnaalishapes_parameter_numsamples(tmp,messages);
}
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_numsamples_rnaalishapes_function_sample");
valid_rnaalishapes_parameter_numsamples = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_numsamples_rnaalishapes_function_sample",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.INTEGER"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_numsamples_rnaalishapes_function_sample",e.getMessage());
}
valid_rnaalishapes_parameter_numsamples = false;}
}
/*--- parameter 'rnaalishapes_parameter_show_samples' --- */
private boolean help_rnaalishapes_parameter_show_samples = false;
public boolean isHelp_rnaalishapes_parameter_show_samples(){
 return help_rnaalishapes_parameter_show_samples;
 }
public void helpAction_rnaalishapes_parameter_show_samples(ActionEvent e){
help_rnaalishapes_parameter_show_samples = !help_rnaalishapes_parameter_show_samples;
} 
private String rnaalishapes_parameter_show_samples=defaultValue_rnaalishapes_parameter_show_samples;
private boolean valid_rnaalishapes_parameter_show_samples= true;
public String getRnaalishapes_parameter_show_samples(){
return rnaalishapes_parameter_show_samples;
}
public void setRnaalishapes_parameter_show_samples(String input){
if (!rnaalishapes_parameter_show_samples.equals(input)) {
try {
Utilities.validate_rnaalishapes_parameter_show_samples(input,messages);
this.rnaalishapes_parameter_show_samples=input;
faultmsg.remove("rnaalishapes_parameter_show_samples_rnaalishapes_function_sample");
valid_rnaalishapes_parameter_show_samples = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_show_samples_rnaalishapes_function_sample",e.getMessage());}
valid_rnaalishapes_parameter_show_samples = false;
}
}
/*--- parameter 'rnaalishapes_parameter_output_probability_filter' --- */private boolean help_rnaalishapes_parameter_output_probability_filter = false;public boolean isHelp_rnaalishapes_parameter_output_probability_filter(){ return help_rnaalishapes_parameter_output_probability_filter;}public void helpAction_rnaalishapes_parameter_output_probability_filter(ActionEvent e){help_rnaalishapes_parameter_output_probability_filter = !help_rnaalishapes_parameter_output_probability_filter;}private String rnaalishapes_parameter_output_probability_filter = defaultValue_rnaalishapes_parameter_output_probability_filter;
private boolean valid_rnaalishapes_parameter_output_probability_filter = true;
public String getRnaalishapes_parameter_output_probability_filter(){return rnaalishapes_parameter_output_probability_filter;}public void setRnaalishapes_parameter_output_probability_filter(String input){
if (!rnaalishapes_parameter_output_probability_filter.equals(input)) {
this.rnaalishapes_parameter_output_probability_filter=input;
try {
if (!input.isEmpty()) {
float tmp =  Float.parseFloat(input);
Utilities.validate_rnaalishapes_parameter_output_probability_filter(tmp,messages);
}
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_output_probability_filter_rnaalishapes_function_sample");
valid_rnaalishapes_parameter_output_probability_filter = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_output_probability_filter_rnaalishapes_function_sample",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.FLOAT"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_output_probability_filter_rnaalishapes_function_sample",e.getMessage());
}
valid_rnaalishapes_parameter_output_probability_filter = false;}
}
/*--- parameter 'rnaalishapes_parameter_decimals_for_probabilities' --- */private boolean help_rnaalishapes_parameter_decimals_for_probabilities = false;public boolean isHelp_rnaalishapes_parameter_decimals_for_probabilities(){ return help_rnaalishapes_parameter_decimals_for_probabilities;}public void helpAction_rnaalishapes_parameter_decimals_for_probabilities(ActionEvent e){help_rnaalishapes_parameter_decimals_for_probabilities = !help_rnaalishapes_parameter_decimals_for_probabilities;}private String rnaalishapes_parameter_decimals_for_probabilities = defaultValue_rnaalishapes_parameter_decimals_for_probabilities;
private boolean valid_rnaalishapes_parameter_decimals_for_probabilities = true;
public String getRnaalishapes_parameter_decimals_for_probabilities(){return rnaalishapes_parameter_decimals_for_probabilities;}public void setRnaalishapes_parameter_decimals_for_probabilities(String input){
if (!rnaalishapes_parameter_decimals_for_probabilities.equals(input)) {
this.rnaalishapes_parameter_decimals_for_probabilities=input;
try {
if (!input.isEmpty()) {
int tmp =  Integer.parseInt(input);
Utilities.validate_rnaalishapes_parameter_decimals_for_probabilities(tmp,messages);
}
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_decimals_for_probabilities_rnaalishapes_function_sample");
valid_rnaalishapes_parameter_decimals_for_probabilities = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_decimals_for_probabilities_rnaalishapes_function_sample",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.INTEGER"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_decimals_for_probabilities_rnaalishapes_function_sample",e.getMessage());
}
valid_rnaalishapes_parameter_decimals_for_probabilities = false;}
}
...
faultmsg.remove("rnaalishapes_parameter_structureprobs_rnaalishapes_function_sample");
valid_rnaalishapes_parameter_structureprobs = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_structureprobs_rnaalishapes_function_sample",e.getMessage());}
...
faultmsg.remove("rnaalishapes_parameter_structure_conservation_index_rnaalishapes_function_sample");
valid_rnaalishapes_parameter_structure_conservation_index = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_structure_conservation_index_rnaalishapes_function_sample",e.getMessage());}
...
faultmsg.remove("rnaalishapes_parameter_consensus_rnaalishapes_function_sample");
valid_rnaalishapes_parameter_consensus = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_consensus_rnaalishapes_function_sample",e.getMessage());}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_pairing_fraction_rnaalishapes_function_sample");
valid_rnaalishapes_parameter_pairing_fraction = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_pairing_fraction_rnaalishapes_function_sample",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.INTEGER"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_pairing_fraction_rnaalishapes_function_sample",e.getMessage());
}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_cfactor_rnaalishapes_function_sample");
valid_rnaalishapes_parameter_cfactor = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_cfactor_rnaalishapes_function_sample",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.FLOAT"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_cfactor_rnaalishapes_function_sample",e.getMessage());
}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_nfactor_rnaalishapes_function_sample");
valid_rnaalishapes_parameter_nfactor = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_nfactor_rnaalishapes_function_sample",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.FLOAT"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_nfactor_rnaalishapes_function_sample",e.getMessage());
}
...
faultmsg.remove("rnaalishapes_parameter_grammar_rnaalishapes_function_sample");
valid_rnaalishapes_parameter_grammar = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_grammar_rnaalishapes_function_sample",e.getMessage());}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_shape_level_rnaalishapes_function_sample");
valid_rnaalishapes_parameter_shape_level = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_shape_level_rnaalishapes_function_sample",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.INTEGER"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_shape_level_rnaalishapes_function_sample",e.getMessage());
}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_temperature_rnaalishapes_function_sample");
valid_rnaalishapes_parameter_temperature = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_temperature_rnaalishapes_function_sample",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.FLOAT"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_temperature_rnaalishapes_function_sample",e.getMessage());
}
...
faultmsg.remove("rnaalishapes_parameter_thermodynamic_model_parameters_rnaalishapes_function_sample");
valid_rnaalishapes_parameter_thermodynamic_model_parameters = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_thermodynamic_model_parameters_rnaalishapes_function_sample",e.getMessage());}
...
faultmsg.remove("rnaalishapes_parameter_lonely_base_pairs_rnaalishapes_function_sample");
valid_rnaalishapes_parameter_lonely_base_pairs = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_lonely_base_pairs_rnaalishapes_function_sample",e.getMessage());}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_window_size_rnaalishapes_function_sample");
valid_rnaalishapes_parameter_window_size = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_window_size_rnaalishapes_function_sample",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.INTEGER"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_window_size_rnaalishapes_function_sample",e.getMessage());
}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_window_increment_rnaalishapes_function_sample");
valid_rnaalishapes_parameter_window_increment = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_window_increment_rnaalishapes_function_sample",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.INTEGER"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_window_increment_rnaalishapes_function_sample",e.getMessage());
}
