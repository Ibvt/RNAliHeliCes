 ...
 */
/**
 * Implementation class  for function rnaalishapes_function_outside_threadworker, implements all request and
 * response methods ...
 *
...
public class rnaalishapes_function_outside_threadworker {


private String fct_id = "rnaalishapes_function_outside";


private static Logger log = Logger.getLogger(rnaalishapes_function_outside_threadworker.class);
...
if (input_0 instanceof AWSValidationConnection) {
   ...
   public void generateUploads(BiBiTools bibitools, Status status, File out, String uploadbucket, String uploadfolder, String accesskey, String secretkey, CmdLineInfo generatedInfo) throws BiBiToolsException, DBConnectionException {
        ...
        // additional output files
        		bibitools.parseUpload(uploadbucket, uploadfolder, accesskey, secretkey, "", "dotPlot.ps", generatedInfo);
    }
}
