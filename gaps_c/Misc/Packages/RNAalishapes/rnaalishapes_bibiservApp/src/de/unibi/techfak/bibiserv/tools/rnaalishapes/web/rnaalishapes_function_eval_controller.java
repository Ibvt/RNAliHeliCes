...
import de.unibi.techfak.bibiserv.tools.rnaalishapes.rnaalishapes_function_eval;
...
/**
 * This is a autogenerated bean controller template class for function <i>rnaalishapes_function_eval_controller</i>
 *
 * @author Daniel Hagemeier - dhagemei[aet]cebitec.uni-bielefeld.de
 *         Armin Toepfer - atoepfer[aet]cebitec.uni-bielefeld.de
 *         Jan Krueger - jkrueger[aet]cebitec.uni-bielefeld.de
 */
public class rnaalishapes_function_eval_controller implements InitializingBean, DisposableBean {

    private final static Logger log = Logger.getLogger(de.unibi.techfak.bibiserv.tools.rnaalishapes.web.rnaalishapes_function_eval_controller.class);
    ...
    public void setInput0(AbstractCloudInputBean rnaalishapes_input_rna_sequence_alignment) {
    ...
    public void setInput1(AbstractCloudInputBean rnaalishapes_input_rna_secondary_structure) {
     ...
     * #     DI method setParam                 #
     * ######################################### */
    public rnaalishapes_function_eval_param param;

    public void setParam(rnaalishapes_function_eval_param param) {
        this.param = param;
    }
     ...
     * #     DI method setResult               #
     * ######################################### */
    public rnaalishapes_function_eval_result result;

    public void setResult(rnaalishapes_function_eval_result result) {
        this.result = result;
    }
     ...
     * ######################################### */
    public rnaalishapes_function_eval_resulthandler resulthandler;

    public void setResulthandler(rnaalishapes_function_eval_resulthandler resulthandler) {
     ...
     * ######################################### */
    public rnaalishapes_function_eval execfunction;

    public void setExecfunction(rnaalishapes_function_eval execfunction) {
    ...
    public String getSupportedFormats0() {
        OntoRepresentation base = execfunction.getRepresentationInput0();
    ...
    public String getSupportedFormatsStream0() {
        OntoRepresentation base = execfunction.getRepresentationInput0();
    ...
    public String getToolMainFormat0() {
        OntoRepresentation base = execfunction.getRepresentationInput0();
        return base.getLabel();
    }
    
    
    public String getSupportedFormats1() {
        OntoRepresentation base = execfunction.getRepresentationInput1();
    ...
    public String getSupportedFormatsStream1() {
        OntoRepresentation base = execfunction.getRepresentationInput1();
    ...
    public String getToolMainFormat1() {
        OntoRepresentation base = execfunction.getRepresentationInput1();
        return base.getLabel();
    }
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        // get DependencyTree
        dptree = pdp.getDependencyTree("rnaalishapes_function_eval", parameterwrapper);
    }
   ...
   /* ###############################################################################
     ...
     * ############################################################################## */
     public void callback() {
        ...
        context.addCallbackParam("validated",true&&rnaalishapes_input_rna_sequence_alignment.isValidated()&&rnaalishapes_input_rna_secondary_structure.isValidated());
                 
         if (true&&rnaalishapes_input_rna_sequence_alignment.isValid()&&rnaalishapes_input_rna_secondary_structure.isValid()) {     
    ...
    public void validate(ActionEvent e) {
        ...
        Thread validation = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                target = execfunction.getRepresentationInput0();
                rnaalishapes_input_rna_sequence_alignment.determineSourceAndValidate(args,target);
                
                target = execfunction.getRepresentationInput1();
        ...
        try {
            ...
            try {
                ...
                if(resulthandler.getResultHandling()==resulthandler.getResultHandling().s3upload) {
                    ...
                    requestid = execfunction.request(pairlist, accesskey, secretkey, uploadbucket, uploadfolder, rnaalishapes_input_rna_sequence_alignment.getInput().getInput(), rnaalishapes_input_rna_sequence_alignment.getInput().getChosen(), rnaalishapes_input_rna_sequence_alignment.supportsStreamedInput(), rnaalishapes_input_rna_sequence_alignment.getInput().isSkipValidation(), rnaalishapes_input_rna_secondary_structure.getInput().getInput(), rnaalishapes_input_rna_secondary_structure.getInput().getChosen(), rnaalishapes_input_rna_secondary_structure.supportsStreamedInput(), rnaalishapes_input_rna_secondary_structure.getInput().isSkipValidation());

                } else {
                    result.setShowMessage(false);
                    requestid = execfunction.request(pairlist, accesskey, secretkey , rnaalishapes_input_rna_sequence_alignment.getInput().getInput(), rnaalishapes_input_rna_sequence_alignment.getInput().getChosen(), rnaalishapes_input_rna_sequence_alignment.supportsStreamedInput(), rnaalishapes_input_rna_sequence_alignment.getInput().isSkipValidation(), rnaalishapes_input_rna_secondary_structure.getInput().getInput(), rnaalishapes_input_rna_secondary_structure.getInput().getChosen(), rnaalishapes_input_rna_secondary_structure.supportsStreamedInput(), rnaalishapes_input_rna_secondary_structure.getInput().isSkipValidation());
            ...
            FacesContext.getCurrentInstance().getExternalContext().redirect("/rnaalishapes?viewType=submission&subType=rnaalishapes_function_eval_result");
    ...
    public void paramSet(ActionEvent e) {
        ...
        try {
            if (dptree.evaluate()) {
                ...
                FacesContext.getCurrentInstance().getExternalContext().redirect("/rnaalishapes?viewType=submission&subType=rnaalishapes_function_eval_p_3");
                ...
                for (Id id : chm.keySet()) {
                    ...
                    if (constraints == null || constraints.isEmpty()) {
                        param.addFaultmsg(id.getId()+"_rnaalishapes_function_eval","Parameter '"+id.getId()+"' is mandantory !");
                    } else {
                        ...
                        param.addFaultmsg(id.getId()+"_rnaalishapes_function_eval",sb.toString());
                    }
                }
            }
    ...
    public int getExampleCount(){             
        return tooldescription.getFunction("rnaalishapes_function_eval").getExample().size();
    }
    ...
    public void example(int i) {
       Texample te = tooldescription.getFunction("rnaalishapes_function_eval").getExample().get(i);
     ...
     public String exampleName(int i) {
        return tooldescription.getFunction("rnaalishapes_function_eval").getExample().get(i).getName().get(0).getValue();
    }
