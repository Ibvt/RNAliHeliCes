 ...
 */
/**
 * Implementation class  for function rnaalishapes_function_eval, implements all request and
 * response methods ...
 *
...
public class rnaalishapes_function_eval {

private BiBiTools bibitools;
private Utilities utilities = new Utilities();


private static Logger log = Logger.getLogger(rnaalishapes_function_eval.class);

    /* #########################################
     * #     DI method setExecfunction          #
     * ######################################### */
    public rnaalishapes_function_eval_threadworker threadworker;

    public void setThreadworker(rnaalishapes_function_eval_threadworker threadworker){
     ...
     * #           Inputs and Outputs           #
     * ######################################### */
	private static final OntoRepresentation representation_input_0 = buildInput0();

	private static OntoRepresentation buildInput0() {
			try {
			return new OntoRepresentationImplementation("Clustal_NA");
		} catch (Exception e) {
	...
	public static OntoRepresentation getRepresentationInput0() {
		 return representation_input_0;
	}
	private static final OntoRepresentation representation_input_1 = buildInput1();

	private static OntoRepresentation buildInput1() {
			try {
	...
	public static OntoRepresentation getRepresentationInput1() {
		 return representation_input_1;
	}
     ...
     * #           Managing Function          #
     * ######################################### */
private String requestImpl( List<Pair<String,String>> paramlist,  String accesskey,  String secretkey,  String uploadbucket,  String uploadfolder, Object input_0, OntoRepresentation representation_0, boolean streamsSupported_0, boolean skipValidation_0, Object input_1, OntoRepresentation representation_1, boolean streamsSupported_1, boolean skipValidation_1) throws BiBiToolsException {
    ...
    try {
        ...
        threadworker.startRequestThread(bibitools, paramlist, accesskey, secretkey, uploadbucket, uploadfolder, getOutputFile(), input_0, representation_0, representation_input_0, streamsSupported_0, skipValidation_0, input_1, representation_1, representation_input_1, streamsSupported_1, skipValidation_1);
    ...
    private File getOutputFile() throws BiBiToolsException, DBConnectionException, IdNotFoundException{
        return bibitools.getOutputFile("rnaalishapes_function_eval");
    }
    ...
    public Object response(String id, OntoRepresentation representation) throws BiBiToolsException, ConversionException {
        try {
     	...
     	public String request(List<Pair<String,String>> param_hash , Object input_0, OntoRepresentation representation_0, Object input_1, OntoRepresentation representation_1) throws BiBiToolsException, ConversionException, ValidationException{
		return request(param_hash, "", "", null, null , input_0, representation_0, false, true, input_1, representation_1, false, true);
	}

	public String request(List<Pair<String,String>> param_hash, String accesskey, String secretkey, Object input_0, OntoRepresentation representation_0, boolean streamsSupported_0, boolean skipValidation_0, Object input_1, OntoRepresentation representation_1, boolean streamsSupported_1, boolean skipValidation_1) throws BiBiToolsException, ConversionException, ValidationException{
		return request(param_hash, accesskey, secretkey, null, null , input_0, representation_0, streamsSupported_0, skipValidation_0, input_1, representation_1, streamsSupported_1, skipValidation_1);
	}

	public String request(List<Pair<String,String>> param_hash, String accesskey, String secretkey, String uploadbucket, String uploadfolder, Object input_0, OntoRepresentation representation_0, boolean streamsSupported_0, boolean skipValidation_0, Object input_1, OntoRepresentation representation_1, boolean streamsSupported_1, boolean skipValidation_1) throws BiBiToolsException, ConversionException, ValidationException{
		...
		if (!(input_0 instanceof ValidationConnection) && !skipValidation_0) {
			...
			converted_input_0 = Utilities.convert(input_0, representation_0, representation_input_0);
		}
		Object converted_input_1 = input_1;
		if (!(input_1 instanceof ValidationConnection) && !skipValidation_1) {
			input_1 = Utilities.validate(input_1, representation_1);
			converted_input_1 = Utilities.convert(input_1, representation_1, representation_input_1);
		}
		return requestImpl(param_hash, accesskey, secretkey, uploadbucket, uploadfolder , converted_input_0, representation_0, streamsSupported_0, skipValidation_0, converted_input_1, representation_1, streamsSupported_1, skipValidation_1);
	}
