 ...
 */
/**
 * Implementation class  for function rnaalishapes_function_eval_threadworker, implements all request and
 * response methods ...
 *
...
public class rnaalishapes_function_eval_threadworker {


private String fct_id = "rnaalishapes_function_eval";


private static Logger log = Logger.getLogger(rnaalishapes_function_eval_threadworker.class);

public void startRequestThread(final BiBiTools bibitools, final List<Pair<String,String>> paramlist, final String accesskey, final String secretkey, final String uploadbucket, final String uploadfolder, final File out,final Object input_0,final OntoRepresentation representation_0,final OntoRepresentation representation_input_0,final boolean streamsSupported_0,final boolean skipValidation_0,final Object input_1,final OntoRepresentation representation_1,final OntoRepresentation representation_input_1,final boolean streamsSupported_1,final boolean skipValidation_1) throws BiBiToolsException {
...
if (input_1 instanceof AWSValidationConnection) {
	String validatorImpl_1;
	List<String> converterChain_1;
	if(skipValidation_1) {
		validatorImpl_1 = null;
		converterChain_1 = null;
	} else {
		validatorImpl_1 = UniversalValidator.getValidatorImlementation(representation_1);
		converterChain_1 = UniversalConverter.getStreamConverterOrder(representation_1, representation_input_1);
	}

	AWSValidationConnection connection = (AWSValidationConnection) input_1;

	postfix += bibitools.parseInputAWS("rnaalishapes_input_rna_secondary_structure",inputhash, connection.getBucket(), connection.getFile(), accesskey, secretkey, generatedInfo, validatorImpl_1, converterChain_1, (representation_1.getContent()!=null) ? representation_1.getContent().name() : "NULL" , (representation_1.getStrictness()!=null) ? representation_1.getStrictness().name() : "NULL" , (representation_1.getCardinality()!=null) ? representation_1.getCardinality().name() : "NULL" , representation_1.getStructure().equals(datastructure.ALIGNMENT) || representation_1.getStructure().equals(datastructure.STRUCTUREALIGNMENT), streamsSupported_1);
} else if (input_1 instanceof URLValidationConnection) {
	String validatorImpl_1;
	List<String> converterChain_1;
	if(skipValidation_1) {
		validatorImpl_1 = null;
	...
	URLValidationConnection connection = (URLValidationConnection) input_1;
	postfix += bibitools.parseInputURL("rnaalishapes_input_rna_secondary_structure",inputhash, connection.getUrl(), generatedInfo, validatorImpl_1, converterChain_1, (representation_1.getContent()!=null) ? representation_1.getContent().name() : "NULL" , (representation_1.getStrictness()!=null) ? representation_1.getStrictness().name() : "NULL" , (representation_1.getCardinality()!=null) ? representation_1.getCardinality().name() : "NULL" , representation_1.getStructure().equals(datastructure.ALIGNMENT) || representation_1.getStructure().equals(datastructure.STRUCTUREALIGNMENT), streamsSupported_1);
} else {
	postfix += bibitools.parseInput("rnaalishapes_input_rna_secondary_structure",inputhash, input_1, representation_1.getType().name(), representation_1.getImplementationType());
}
