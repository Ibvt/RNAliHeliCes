...
/**
 * This is a autogenerated bean result template class for function <i>rnaalishapes_function_subopt_result</i>
 *
 ...
 */
public class rnaalishapes_function_subopt_result implements ToolFunctionResult {

    Logger log = Logger.getLogger(rnaalishapes_function_subopt_result.class);
    ...
    public boolean applyVisualizer(OntoRepresentation type, String visualizer){
        try {
            ...
            FacesContext.getCurrentInstance().getExternalContext().redirect("/rnaalishapes?viewType=submission&subType=rnaalishapes_function_subopt_visualization");
        } catch (Exception e){
            log.fatal(e.getMessage(),e);
            return false;
        }
