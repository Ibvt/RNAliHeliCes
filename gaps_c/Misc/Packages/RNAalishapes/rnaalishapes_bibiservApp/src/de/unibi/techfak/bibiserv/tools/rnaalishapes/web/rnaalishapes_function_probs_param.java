...
/**
 * This is a autogenerated bean input template class for function <i>rnaalishapes_function_probs_param</i>
 *
 ...
 */
 public class rnaalishapes_function_probs_param   { 

     private final static Logger log = Logger.getLogger(rnaalishapes_function_probs_param.class);
     ...
     * ######################################### */
    private static final String defaultValue_rnaalishapes_parameter_low_probability_filter="0.000001";
...
public void reset(){
rnaalishapes_parameter_low_probability_filter = defaultValue_rnaalishapes_parameter_low_probability_filter;
...
if (true 
&& rnaalishapes_parameter_low_probability_filter.equals(defaultValue_rnaalishapes_parameter_low_probability_filter)
...
return true;
     ...
     * ######################################### */
     public boolean isValid(){
        return true
                ...
                && valid_rnaalishapes_parameter_low_probability_filter
    ...
    public boolean checkAndSet(Prop p) {
        ...
        if (p.getIdref().equals("rnaalishapes_parameter_low_probability_filter")) {
            rnaalishapes_parameter_low_probability_filter = p.getValue();
            return true;
        }
    ...
    public List<Pair<String, String>> getParameterList() {
        ...
        if (!rnaalishapes_parameter_low_probability_filter.isEmpty()) {
            pairlist.add(new Pair<String, String>("rnaalishapes_parameter_low_probability_filter", rnaalishapes_parameter_low_probability_filter));
        }
     ...
     * ######################################### */
     /*--- parameter 'rnaalishapes_parameter_low_probability_filter' --- */private boolean help_rnaalishapes_parameter_low_probability_filter = false;public boolean isHelp_rnaalishapes_parameter_low_probability_filter(){ return help_rnaalishapes_parameter_low_probability_filter;}public void helpAction_rnaalishapes_parameter_low_probability_filter(ActionEvent e){help_rnaalishapes_parameter_low_probability_filter = !help_rnaalishapes_parameter_low_probability_filter;}private String rnaalishapes_parameter_low_probability_filter = defaultValue_rnaalishapes_parameter_low_probability_filter;
private boolean valid_rnaalishapes_parameter_low_probability_filter = true;
public String getRnaalishapes_parameter_low_probability_filter(){return rnaalishapes_parameter_low_probability_filter;}public void setRnaalishapes_parameter_low_probability_filter(String input){
if (!rnaalishapes_parameter_low_probability_filter.equals(input)) {
this.rnaalishapes_parameter_low_probability_filter=input;
try {
if (!input.isEmpty()) {
float tmp =  Float.parseFloat(input);
Utilities.validate_rnaalishapes_parameter_low_probability_filter(tmp,messages);
}
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_low_probability_filter_rnaalishapes_function_probs");
valid_rnaalishapes_parameter_low_probability_filter = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_low_probability_filter_rnaalishapes_function_probs",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.FLOAT"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_low_probability_filter_rnaalishapes_function_probs",e.getMessage());
}
valid_rnaalishapes_parameter_low_probability_filter = false;}
}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_output_probability_filter_rnaalishapes_function_probs");
valid_rnaalishapes_parameter_output_probability_filter = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_output_probability_filter_rnaalishapes_function_probs",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.FLOAT"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_output_probability_filter_rnaalishapes_function_probs",e.getMessage());
}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_decimals_for_probabilities_rnaalishapes_function_probs");
valid_rnaalishapes_parameter_decimals_for_probabilities = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_decimals_for_probabilities_rnaalishapes_function_probs",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.INTEGER"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_decimals_for_probabilities_rnaalishapes_function_probs",e.getMessage());
}
...
faultmsg.remove("rnaalishapes_parameter_structureprobs_rnaalishapes_function_probs");
valid_rnaalishapes_parameter_structureprobs = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_structureprobs_rnaalishapes_function_probs",e.getMessage());}
...
faultmsg.remove("rnaalishapes_parameter_structure_conservation_index_rnaalishapes_function_probs");
valid_rnaalishapes_parameter_structure_conservation_index = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_structure_conservation_index_rnaalishapes_function_probs",e.getMessage());}
...
faultmsg.remove("rnaalishapes_parameter_consensus_rnaalishapes_function_probs");
valid_rnaalishapes_parameter_consensus = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_consensus_rnaalishapes_function_probs",e.getMessage());}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_pairing_fraction_rnaalishapes_function_probs");
valid_rnaalishapes_parameter_pairing_fraction = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_pairing_fraction_rnaalishapes_function_probs",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.INTEGER"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_pairing_fraction_rnaalishapes_function_probs",e.getMessage());
}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_cfactor_rnaalishapes_function_probs");
valid_rnaalishapes_parameter_cfactor = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_cfactor_rnaalishapes_function_probs",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.FLOAT"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_cfactor_rnaalishapes_function_probs",e.getMessage());
}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_nfactor_rnaalishapes_function_probs");
valid_rnaalishapes_parameter_nfactor = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_nfactor_rnaalishapes_function_probs",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.FLOAT"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_nfactor_rnaalishapes_function_probs",e.getMessage());
}
...
faultmsg.remove("rnaalishapes_parameter_grammar_rnaalishapes_function_probs");
valid_rnaalishapes_parameter_grammar = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_grammar_rnaalishapes_function_probs",e.getMessage());}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_shape_level_rnaalishapes_function_probs");
valid_rnaalishapes_parameter_shape_level = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_shape_level_rnaalishapes_function_probs",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.INTEGER"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_shape_level_rnaalishapes_function_probs",e.getMessage());
}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_temperature_rnaalishapes_function_probs");
valid_rnaalishapes_parameter_temperature = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_temperature_rnaalishapes_function_probs",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.FLOAT"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_temperature_rnaalishapes_function_probs",e.getMessage());
}
...
faultmsg.remove("rnaalishapes_parameter_thermodynamic_model_parameters_rnaalishapes_function_probs");
valid_rnaalishapes_parameter_thermodynamic_model_parameters = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_thermodynamic_model_parameters_rnaalishapes_function_probs",e.getMessage());}
...
faultmsg.remove("rnaalishapes_parameter_lonely_base_pairs_rnaalishapes_function_probs");
valid_rnaalishapes_parameter_lonely_base_pairs = true;
return;
} catch (ValidationException e){
faultmsg.put("rnaalishapes_parameter_lonely_base_pairs_rnaalishapes_function_probs",e.getMessage());}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_window_size_rnaalishapes_function_probs");
valid_rnaalishapes_parameter_window_size = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_window_size_rnaalishapes_function_probs",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.INTEGER"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_window_size_rnaalishapes_function_probs",e.getMessage());
}
...
//remove possible previous set faultmsg
faultmsg.remove("rnaalishapes_parameter_window_increment_rnaalishapes_function_probs");
valid_rnaalishapes_parameter_window_increment = true;
return;
}catch (NumberFormatException e) {
faultmsg.put("rnaalishapes_parameter_window_increment_rnaalishapes_function_probs",messages.property("de.unibi.techfak.bibiserv.bibimainapp.input.param.num.INTEGER"));
}catch (ValidationException e) {
faultmsg.put("rnaalishapes_parameter_window_increment_rnaalishapes_function_probs",e.getMessage());
}
