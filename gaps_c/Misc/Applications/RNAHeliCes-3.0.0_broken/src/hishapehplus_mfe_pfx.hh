...
#ifndef hishapehplus_mfe_pfx_hh
#define hishapehplus_mfe_pfx_hh
...
class hishapehplus_mfe_pfx_insp_hash_h_hplus_pfx {
public:
...
typedef Hash::Ref<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx_insp_hash_h_hplus_pfx > hishapehplus_mfe_pfx_hash_h_hplus_pfx;


class hishapehplus_mfe_pfx {
...
hishapehplus_mfe_pfx_hash_h_hplus_pfx LBRope_firstG_Bmfeanswer_firstG_pfanswer_secondG_E_secondG_EMhdecl0x1597270_zero;
...
unsigned int t_0_left_most;
unsigned int t_0_right_most;
std::vector<hishapehplus_mfe_pfx_hash_h_hplus_pfx > array;
std::vector<bool> tabulated;
unsigned int t_0_n;
hishapehplus_mfe_pfx_hash_h_hplus_pfx zero;
unsigned int size()
{
...
hishapehplus_mfe_pfx_hash_h_hplus_pfx &  get(unsigned int t_0_i, unsigned int t_0_j)
{
  assert( (t_0_i <= t_0_j));
  assert( (t_0_j <= t_0_n));
  if (((t_0_j - t_0_i) < 8))
...
void set(unsigned int t_0_i, unsigned int t_0_j,  const hishapehplus_mfe_pfx_hash_h_hplus_pfx &  e)
{
  assert( (t_0_i <= t_0_j));
  assert( (t_0_j <= t_0_n));
  if (((t_0_j - t_0_i) < 8))
...
void clear() { tabulated.clear(); }
hishapehplus_mfe_pfx_hash_h_hplus_pfx &  get(unsigned int t_0_i)
{
  unsigned int t_0_j = t_0_n;
  assert( (t_0_i <= t_0_j));
  assert( (t_0_j <= t_0_n));
...
void set(unsigned int t_0_i,  const hishapehplus_mfe_pfx_hash_h_hplus_pfx &  e)
{
  unsigned int t_0_j = t_0_n;
  assert( (t_0_i <= t_0_j));
  assert( (t_0_j <= t_0_n));
...
void init(const std::vector<std::pair<const char *, unsigned> > &inp, uint32_t kbest, const std::string &matchStr, const bool exact)
{
...
empty(LBRope_firstG_Bmfeanswer_firstG_pfanswer_secondG_E_secondG_EMhdecl0x1597270_zero);

t_0_left_most = 0;
t_0_right_most = t_0_seq.size();
hishapehplus_mfe_pfx_insp_hash_h_hplus_pfx::set_k(kbest);
  ...
  private:
    ...
    bool _exact; 
    hishapehplus_mfe_pfx_hash_h_hplus_pfx &  nt_block_dl(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx &  nt_block_dlr(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx &  nt_closed(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx nt_dl_or_ss_left_no_ss_end(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx &  nt_dl_or_ss_left_ss_end(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx nt_edanglel_ml(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx nt_edanglel_struct(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx nt_edanglelr_ml(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx nt_edanglelr_struct(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx &  nt_edangler_ml(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx nt_edangler_struct(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx nt_hairpin(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx nt_iloop(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx nt_initstem(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx nt_leftB(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx &  nt_left_dangle(unsigned int t_0_i);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx &  nt_left_unpaired(unsigned int t_0_i);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx &  nt_ml_comps1(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx &  nt_ml_comps2(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx &  nt_ml_comps3(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx &  nt_ml_comps4(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx nt_multiloop(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx &  nt_no_dl_no_ss_end(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx &  nt_no_dl_ss_end(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx &  nt_nodangle_ml(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx nt_nodangle_struct(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx &  nt_noleft_dangle(unsigned int t_0_i);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx nt_rightB(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx nt_stack(unsigned int t_0_i, unsigned int t_0_j);
    hishapehplus_mfe_pfx_hash_h_hplus_pfx nt_struct();
...
template <typename Iterator>
    hishapehplus_mfe_pfx_hash_h_hplus_pfx h(std::pair<Iterator, Iterator> i)
;
 ...
 public:
   hishapehplus_mfe_pfx_hash_h_hplus_pfx run()
{
  return nt_struct();
}
...
{
  intrusive_ptr<Backtrace_nt_struct_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_struct_Front(intrusive_ptr<Backtrace_nt_struct_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
...
{
  intrusive_ptr<Backtrace_nt_left_unpaired_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_left_unpaired_Front(intrusive_ptr<Backtrace_nt_left_unpaired_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_left_dangle_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_left_dangle_Front(intrusive_ptr<Backtrace_nt_left_dangle_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_noleft_dangle_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_noleft_dangle_Front(intrusive_ptr<Backtrace_nt_noleft_dangle_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_edanglel_struct_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_edanglel_struct_Front(intrusive_ptr<Backtrace_nt_edanglel_struct_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_edangler_struct_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_edangler_struct_Front(intrusive_ptr<Backtrace_nt_edangler_struct_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_edanglelr_struct_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_edanglelr_struct_Front(intrusive_ptr<Backtrace_nt_edanglelr_struct_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_nodangle_struct_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_nodangle_struct_Front(intrusive_ptr<Backtrace_nt_nodangle_struct_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_edanglel_ml_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_edanglel_ml_Front(intrusive_ptr<Backtrace_nt_edanglel_ml_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_edangler_ml_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_edangler_ml_Front(intrusive_ptr<Backtrace_nt_edangler_ml_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_edanglelr_ml_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_edanglelr_ml_Front(intrusive_ptr<Backtrace_nt_edanglelr_ml_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_nodangle_ml_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_nodangle_ml_Front(intrusive_ptr<Backtrace_nt_nodangle_ml_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_initstem_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_initstem_Front(intrusive_ptr<Backtrace_nt_initstem_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_closed_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_closed_Front(intrusive_ptr<Backtrace_nt_closed_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_multiloop_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_multiloop_Front(intrusive_ptr<Backtrace_nt_multiloop_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_ml_comps1_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_ml_comps1_Front(intrusive_ptr<Backtrace_nt_ml_comps1_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_ml_comps2_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_ml_comps2_Front(intrusive_ptr<Backtrace_nt_ml_comps2_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_ml_comps3_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_ml_comps3_Front(intrusive_ptr<Backtrace_nt_ml_comps3_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_ml_comps4_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_ml_comps4_Front(intrusive_ptr<Backtrace_nt_ml_comps4_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_block_dl_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_block_dl_Front(intrusive_ptr<Backtrace_nt_block_dl_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_block_dlr_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_block_dlr_Front(intrusive_ptr<Backtrace_nt_block_dlr_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_no_dl_no_ss_end_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_no_dl_no_ss_end_Front(intrusive_ptr<Backtrace_nt_no_dl_no_ss_end_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_dl_or_ss_left_no_ss_end_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_dl_or_ss_left_no_ss_end_Front(intrusive_ptr<Backtrace_nt_dl_or_ss_left_no_ss_end_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_no_dl_ss_end_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_no_dl_ss_end_Front(intrusive_ptr<Backtrace_nt_no_dl_ss_end_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_dl_or_ss_left_ss_end_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_dl_or_ss_left_ss_end_Front(intrusive_ptr<Backtrace_nt_dl_or_ss_left_ss_end_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_stack_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_stack_Front(intrusive_ptr<Backtrace_nt_stack_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_hairpin_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_hairpin_Front(intrusive_ptr<Backtrace_nt_hairpin_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_leftB_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_leftB_Front(intrusive_ptr<Backtrace_nt_leftB_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_rightB_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_rightB_Front(intrusive_ptr<Backtrace_nt_rightB_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_iloop_Back<hishapehplus_mfe_pfx, Value, pos_int> > back;

Backtrace_nt_iloop_Front(intrusive_ptr<Backtrace_nt_iloop_Back<hishapehplus_mfe_pfx, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , hishapehplus_mfe_pfx, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
intrusive_ptr<Eval_List<Value> > eval()
{
  ...
  return t->eval();
    ...
    List_Ref<std::pair<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , intrusive_ptr<Backtrace<String, unsigned int> > > > h_bt(List_Ref<std::pair<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , intrusive_ptr<Backtrace<String, unsigned int> > > > i, hishapehplus_mfe_pfx_hash_h_hplus_pfx &  left_answers);
template <typename Iterator>
    List_Ref<std::pair<std::pair<Rope, std::pair<mfeanswer, pfanswer> > , intrusive_ptr<Backtrace<String, unsigned int> > > > h_bt(std::pair<Iterator, Iterator> i, hishapehplus_mfe_pfx_hash_h_hplus_pfx &  left_answers)
;
...
namespace gapc {
  typedef hishapehplus_mfe_pfx hishapehplus_pfx_cls;
  typedef hishapehplus_mfe_pfx_hash_h_hplus_pfx hishapehplus_pfx_ret;
}
#endif
