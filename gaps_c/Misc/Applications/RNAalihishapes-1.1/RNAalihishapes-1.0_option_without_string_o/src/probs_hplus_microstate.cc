...
// 
//   GAP-C call:
//     /home/jhuang/local/gapc/bin/gapc -I ../../../ -p ((alg_ali_hishape_hplus * (alg_ali_mfe % alg_ali_pfunc)) suchthat filterLowProbShapes) * (alg_ali_dotBracket * alg_ali_pfunc) ../../../ali_microstate.gap --kbacktrace --no-coopt-class --kbest -o probs_hplus_microstate.cc 
// 
// 
...
uint32_t probs_hplus_microstate_insp_hash_h::k_ = 3;
...
probs_hplus_microstate_hash_h &  probs_hplus_microstate::nt_dangle(unsigned int t_0_i, unsigned int t_0_j)
{
  ...
  probs_hplus_microstate_hash_h answers;
  empty(answers);
  empty( answers);
  ...
  if (((t_0_j - t_0_i) >= 6))
  {
    ...
    if (is_not_empty(a_2))
    {
      ...
      if (is_not_empty(a_0))
      {
        probs_hplus_microstate_hash_h ret_2 = nt_strong((t_0_i + 1), t_0_j);
        probs_hplus_microstate_hash_h a_1 = ret_2;
        if (is_not_empty(a_1))
          {
            for (probs_hplus_microstate_hash_h::iterator x_1_itr = a_1.ref().begin(); x_1_itr!=a_1.ref().end(); ++x_1_itr){
  ...
  if (((t_0_j - t_0_i) >= 6))
  {
    ...
    if (is_not_empty(a_5))
    {
      ...
      if (is_not_empty(a_3))
      {
        probs_hplus_microstate_hash_h ret_6 = nt_strong(t_0_i, (t_0_j - 1));
        probs_hplus_microstate_hash_h a_4 = ret_6;
        if (is_not_empty(a_4))
          {
            for (probs_hplus_microstate_hash_h::iterator x_4_itr = a_4.ref().begin(); x_4_itr!=a_4.ref().end(); ++x_4_itr){
  ...
  if (((t_0_j - t_0_i) >= 7))
  {
    ...
    if (is_not_empty(a_8))
    {
      ...
      if (is_not_empty(a_6))
      {
        probs_hplus_microstate_hash_h ret_10 = nt_strong((t_0_i + 1), (t_0_j - 1));
        probs_hplus_microstate_hash_h a_7 = ret_10;
        if (is_not_empty(a_7))
          {
            for (probs_hplus_microstate_hash_h::iterator x_7_itr = a_7.ref().begin(); x_7_itr!=a_7.ref().end(); ++x_7_itr){
  ...
  if (((t_0_j - t_0_i) >= 5))
  {
    ...
    if (is_not_empty(a_11))
    {
      ...
      if (is_not_empty(a_9))
      {
        probs_hplus_microstate_hash_h ret_14 = nt_strong(t_0_i, t_0_j);
        probs_hplus_microstate_hash_h a_10 = ret_14;
        if (is_not_empty(a_10))
          {
            for (probs_hplus_microstate_hash_h::iterator x_10_itr = a_10.ref().begin(); x_10_itr!=a_10.ref().end(); ++x_10_itr){
...
probs_hplus_microstate_hash_h probs_hplus_microstate::nt_hairpin(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 5))
    {
      return LBRope_firstG_Bmfecovar_firstG_float_secondG_E_secondG_EMhdecl0x2c77ad0_zero;
    }
...
probs_hplus_microstate_hash_h &  probs_hplus_microstate::nt_iloop(unsigned int t_0_i, unsigned int t_0_j)
{
              ...
              if (is_not_empty(a_4))
              {
                ...
                if (is_not_empty(a_3))
                {
                  ...
                  if (is_not_empty(a_1))
                  {
                    ...
                    if (is_not_empty(a_0))
                    {
                      probs_hplus_microstate_hash_h ret_3 = nt_strong(t_0_k_0, t_0_k_1);
                      probs_hplus_microstate_hash_h a_2 = ret_3;
                      if (is_not_empty(a_2))
                        {
                          for (probs_hplus_microstate_hash_h::iterator x_2_itr = a_2.ref().begin(); x_2_itr!=a_2.ref().end(); ++x_2_itr){
...
probs_hplus_microstate_hash_h probs_hplus_microstate::nt_leftB(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 8))
    {
      return LBRope_firstG_Bmfecovar_firstG_float_secondG_E_secondG_EMhdecl0x2c77ad0_zero;
          ...
          for(          unsigned int t_0_k_0 = (t_0_i + 2); ((t_0_k_0 <= (t_0_j - 6)) && (t_0_k_0 <= (t_0_i + 31))); ++t_0_k_0)
          {
            ...
            if (is_not_empty(a_3))
            {
              ...
              if (is_not_empty(a_1))
              {
                ...
                if (is_not_empty(a_0))
                {
                  probs_hplus_microstate_hash_h ret_3 = nt_strong(t_0_k_0, (t_0_j - 1));
                  probs_hplus_microstate_hash_h a_2 = ret_3;
                  if (is_not_empty(a_2))
                    {
                      for (probs_hplus_microstate_hash_h::iterator x_2_itr = a_2.ref().begin(); x_2_itr!=a_2.ref().end(); ++x_2_itr){
...
probs_hplus_microstate_hash_h &  probs_hplus_microstate::nt_ml_comps(unsigned int t_0_i, unsigned int t_0_j)
{
  ...
  if (((t_0_j - t_0_i) >= 11))
  {
    ...
    if (is_not_empty(a_0))
    {
      probs_hplus_microstate_hash_h ret_2 = nt_ml_comps((t_0_i + 1), t_0_j);
      probs_hplus_microstate_hash_h a_1 = ret_2;
      if (is_not_empty(a_1))
        {
          for (probs_hplus_microstate_hash_h::iterator x_1_itr = a_1.ref().begin(); x_1_itr!=a_1.ref().end(); ++x_1_itr){
  ...
  if (((t_0_j - t_0_i) >= 10))
    {
      ...
      {
        probs_hplus_microstate_hash_h ret_6 = nt_ml_comps1(t_0_k_0, t_0_j);
        probs_hplus_microstate_hash_h a_4 = ret_6;
        if (is_not_empty(a_4))
        {
          probs_hplus_microstate_hash_h ret_4;
          empty(ret_4);
          if (((t_0_k_0 - t_0_i) >= 5))
          {
            probs_hplus_microstate_hash_h ret_5 = nt_dangle(t_0_i, t_0_k_0);
            probs_hplus_microstate_hash_h a_3 = ret_5;
            if (is_not_empty(a_3))
              {
                for (probs_hplus_microstate_hash_h::iterator x_3_itr = a_3.ref().begin(); x_3_itr!=a_3.ref().end(); ++x_3_itr){
          ...
          finalize( ret_4);
          probs_hplus_microstate_hash_h a_2 = ret_4;
          if (is_not_empty(a_2))
            {
              for (probs_hplus_microstate_hash_h::iterator x_2_itr = a_2.ref().begin(); x_2_itr!=a_2.ref().end(); ++x_2_itr){
                std::pair<Rope, std::pair<mfecovar, double> >  x_2 = *x_2_itr;
...
probs_hplus_microstate_hash_h &  probs_hplus_microstate::nt_ml_comps1(unsigned int t_0_i, unsigned int t_0_j)
{
  ...
  if (((t_0_j - t_0_i) >= 6))
  {
    ...
    if (is_not_empty(a_0))
    {
      probs_hplus_microstate_hash_h ret_2 = nt_ml_comps1((t_0_i + 1), t_0_j);
      probs_hplus_microstate_hash_h a_1 = ret_2;
      if (is_not_empty(a_1))
        {
          for (probs_hplus_microstate_hash_h::iterator x_1_itr = a_1.ref().begin(); x_1_itr!=a_1.ref().end(); ++x_1_itr){
  ...
  if (((t_0_j - t_0_i) >= 5))
  {
    probs_hplus_microstate_hash_h ret_8 = nt_dangle(t_0_i, t_0_j);
    probs_hplus_microstate_hash_h a_5 = ret_8;
    if (is_not_empty(a_5))
      {
        for (probs_hplus_microstate_hash_h::iterator x_5_itr = a_5.ref().begin(); x_5_itr!=a_5.ref().end(); ++x_5_itr){
  ...
  if (((t_0_j - t_0_i) >= 6))
    {
      for(      unsigned int t_0_k_1 = (t_0_i + 5); (t_0_k_1 <= (t_0_j - 1)); ++t_0_k_1)
      {
        ...
        if (is_not_empty(a_8))
        {
          probs_hplus_microstate_hash_h ret_10;
          empty(ret_10);
          if (((t_0_k_1 - t_0_i) >= 5))
          {
            probs_hplus_microstate_hash_h ret_11 = nt_dangle(t_0_i, t_0_k_1);
            probs_hplus_microstate_hash_h a_7 = ret_11;
            if (is_not_empty(a_7))
              {
                for (probs_hplus_microstate_hash_h::iterator x_7_itr = a_7.ref().begin(); x_7_itr!=a_7.ref().end(); ++x_7_itr){
                  std::pair<Rope, std::pair<mfecovar, double> >  x_7 = *x_7_itr;
          ...
          finalize( ret_10);
          probs_hplus_microstate_hash_h a_6 = ret_10;
          if (is_not_empty(a_6))
            {
              for (probs_hplus_microstate_hash_h::iterator x_6_itr = a_6.ref().begin(); x_6_itr!=a_6.ref().end(); ++x_6_itr){
...
probs_hplus_microstate_hash_h probs_hplus_microstate::nt_multiloop(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 12))
    {
      return LBRope_firstG_Bmfecovar_firstG_float_secondG_E_secondG_EMhdecl0x2c77ad0_zero;
  ...
  if (((t_0_j - t_0_i) >= 12))
    {
      if (basepair(t_0_seq, t_0_i, t_0_j))
      {
        ...
        if (is_not_empty(a_2))
        {
          ...
          if (is_not_empty(a_0))
          {
            probs_hplus_microstate_hash_h ret_2 = nt_ml_comps((t_0_i + 1), (t_0_j - 1));
            probs_hplus_microstate_hash_h a_1 = ret_2;
            if (is_not_empty(a_1))
              {
                for (probs_hplus_microstate_hash_h::iterator x_1_itr = a_1.ref().begin(); x_1_itr!=a_1.ref().end(); ++x_1_itr){
      ...
      if (basepair(t_0_seq, t_0_i, t_0_j))
      {
        ...
        if (is_not_empty(a_6))
        {
          ...
          if (is_not_empty(a_4))
          {
            ...
            if (is_not_empty(a_3))
            {
              probs_hplus_microstate_hash_h ret_7 = nt_ml_comps((t_0_i + 2), (t_0_j - 1));
              probs_hplus_microstate_hash_h a_5 = ret_7;
              if (is_not_empty(a_5))
                {
                  for (probs_hplus_microstate_hash_h::iterator x_5_itr = a_5.ref().begin(); x_5_itr!=a_5.ref().end(); ++x_5_itr){
                    std::pair<Rope, std::pair<mfecovar, double> >  x_5 = *x_5_itr;
      ...
      if (basepair(t_0_seq, t_0_i, t_0_j))
      {
        ...
        if (is_not_empty(a_10))
        {
          ...
          if (is_not_empty(a_9))
          {
            ...
            if (is_not_empty(a_7))
            {
              probs_hplus_microstate_hash_h ret_11 = nt_ml_comps((t_0_i + 1), (t_0_j - 2));
              probs_hplus_microstate_hash_h a_8 = ret_11;
              if (is_not_empty(a_8))
                {
                  for (probs_hplus_microstate_hash_h::iterator x_8_itr = a_8.ref().begin(); x_8_itr!=a_8.ref().end(); ++x_8_itr){
        ...
        if (is_not_empty(a_15))
        {
          ...
          if (is_not_empty(a_14))
          {
            ...
            if (is_not_empty(a_12))
            {
              ...
              if (is_not_empty(a_11))
              {
                probs_hplus_microstate_hash_h ret_17 = nt_ml_comps((t_0_i + 2), (t_0_j - 2));
                probs_hplus_microstate_hash_h a_13 = ret_17;
                if (is_not_empty(a_13))
                  {
                    for (probs_hplus_microstate_hash_h::iterator x_13_itr = a_13.ref().begin(); x_13_itr!=a_13.ref().end(); ++x_13_itr){
...
probs_hplus_microstate_hash_h probs_hplus_microstate::nt_rightB(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 8))
    {
      return LBRope_firstG_Bmfecovar_firstG_float_secondG_E_secondG_EMhdecl0x2c77ad0_zero;
          ...
          for(          unsigned int t_0_k_0 = (((t_0_j - (t_0_i + 6)) >= 31)) ? ((t_0_j - 31)) : ((t_0_i + 6)); (t_0_k_0 <= (t_0_j - 2)); ++t_0_k_0)
          {
            ...
            if (is_not_empty(a_3))
            {
              ...
              if (is_not_empty(a_2))
              {
                ...
                if (is_not_empty(a_0))
                {
                  probs_hplus_microstate_hash_h ret_2 = nt_strong((t_0_i + 1), t_0_k_0);
                  probs_hplus_microstate_hash_h a_1 = ret_2;
                  if (is_not_empty(a_1))
                    {
                      for (probs_hplus_microstate_hash_h::iterator x_1_itr = a_1.ref().begin(); x_1_itr!=a_1.ref().end(); ++x_1_itr){
...
probs_hplus_microstate_hash_h probs_hplus_microstate::nt_stack(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 7))
    {
      return LBRope_firstG_Bmfecovar_firstG_float_secondG_E_secondG_EMhdecl0x2c77ad0_zero;
  ...
  if (((t_0_j - t_0_i) >= 7))
    {
      if (basepair(t_0_seq, t_0_i, t_0_j))
      {
        ...
        if (is_not_empty(a_2))
        {
          ...
          if (is_not_empty(a_0))
          {
            probs_hplus_microstate_hash_h ret_2 = nt_weak((t_0_i + 1), (t_0_j - 1));
            probs_hplus_microstate_hash_h a_1 = ret_2;
            if (is_not_empty(a_1))
              {
                for (probs_hplus_microstate_hash_h::iterator x_1_itr = a_1.ref().begin(); x_1_itr!=a_1.ref().end(); ++x_1_itr){
...
probs_hplus_microstate_hash_h &  probs_hplus_microstate::nt_strong(unsigned int t_0_i, unsigned int t_0_j)
{
  ...
  {
    probs_hplus_microstate_hash_h ret_1;
    empty(ret_1);
    if (((t_0_j - t_0_i) >= 7))
      {
        if (basepair(t_0_seq, t_0_i, t_0_j))
        {
          ...
          if (is_not_empty(a_2))
          {
            ...
            if (is_not_empty(a_0))
            {
              probs_hplus_microstate_hash_h ret_3 = nt_weak((t_0_i + 1), (t_0_j - 1));
              probs_hplus_microstate_hash_h a_1 = ret_3;
              if (is_not_empty(a_1))
                {
                  for (probs_hplus_microstate_hash_h::iterator x_1_itr = a_1.ref().begin(); x_1_itr!=a_1.ref().end(); ++x_1_itr){
                    std::pair<Rope, std::pair<mfecovar, double> >  x_1 = *x_1_itr;
  ...
  {
    probs_hplus_microstate_hash_h ret_6 = nt_weak(t_0_i, t_0_j);
...
probs_hplus_microstate_hash_h &  probs_hplus_microstate::nt_struct(unsigned int t_0_i)
{
  ...
  if (((t_0_right_most - t_0_i) >= 1))
  {
    ...
    if (is_not_empty(a_0))
    {
      probs_hplus_microstate_hash_h ret_2 = nt_struct((t_0_i + 1));
      probs_hplus_microstate_hash_h a_1 = ret_2;
      if (is_not_empty(a_1))
        {
          for (probs_hplus_microstate_hash_h::iterator x_1_itr = a_1.ref().begin(); x_1_itr!=a_1.ref().end(); ++x_1_itr){
  ...
  if (((t_0_right_most - t_0_i) >= 5))
    {
      ...
      {
        probs_hplus_microstate_hash_h ret_5 = nt_struct(t_0_k_0);
        probs_hplus_microstate_hash_h a_3 = ret_5;
        if (is_not_empty(a_3))
        {
          probs_hplus_microstate_hash_h ret_4 = nt_dangle(t_0_i, t_0_k_0);
          probs_hplus_microstate_hash_h a_2 = ret_4;
          if (is_not_empty(a_2))
            {
              for (probs_hplus_microstate_hash_h::iterator x_2_itr = a_2.ref().begin(); x_2_itr!=a_2.ref().end(); ++x_2_itr){
...
probs_hplus_microstate_hash_h &  probs_hplus_microstate::nt_weak(unsigned int t_0_i, unsigned int t_0_j)
{
  ...
  probs_hplus_microstate_hash_h ret_1 = nt_stack(t_0_i, t_0_j);
  append( answers, ret_1);
  probs_hplus_microstate_hash_h ret_2 = nt_hairpin(t_0_i, t_0_j);
  append( answers, ret_2);
  probs_hplus_microstate_hash_h ret_3 = nt_leftB(t_0_i, t_0_j);
  append( answers, ret_3);
  probs_hplus_microstate_hash_h ret_4 = nt_rightB(t_0_i, t_0_j);
  append( answers, ret_4);
  probs_hplus_microstate_hash_h ret_5 = nt_iloop(t_0_i, t_0_j);
  append( answers, ret_5);
  probs_hplus_microstate_hash_h ret_6 = nt_multiloop(t_0_i, t_0_j);
  append( answers, ret_6);
  hash_filter( answers);
  finalize( answers);
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::addss(const std::pair<Rope, std::pair<mfecovar, double> > & p_e, const TUSubsequence & p_rb)
{
  Rope l_0 = p_e.first;
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::bl(const TUSubsequence & p_lb, const TUSubsequence & p_lregion, const std::pair<Rope, std::pair<mfecovar, double> > & p_e, const TUSubsequence & p_rb)
{
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::br(const TUSubsequence & p_lb, const std::pair<Rope, std::pair<mfecovar, double> > & p_e, const TUSubsequence & p_rregion, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  Rope l_1 = p_e.first;
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::cadd(const std::pair<Rope, std::pair<mfecovar, double> > & p_le, const std::pair<Rope, std::pair<mfecovar, double> > & p_re)
{
  Rope l_0 = p_le.first;
  Rope l_1 = p_re.first;
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::drem(const TUSubsequence & p_lloc, const std::pair<Rope, std::pair<mfecovar, double> > & p_e, const TUSubsequence & p_rloc)
{
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::edl(const TUSubsequence & p_lb, const std::pair<Rope, std::pair<mfecovar, double> > & p_e, const TUSubsequence & p_rloc)
{
  TUSubsequence l_0 = p_lb;
  Rope l_1 = p_e.first;
  TUSubsequence l_2 = p_rloc;
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::edlr(const TUSubsequence & p_lb, const std::pair<Rope, std::pair<mfecovar, double> > & p_e, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  Rope l_1 = p_e.first;
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::edr(const TUSubsequence & p_lloc, const std::pair<Rope, std::pair<mfecovar, double> > & p_e, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lloc;
  Rope l_1 = p_e.first;
  TUSubsequence l_2 = p_rb;
...
probs_hplus_microstate_hash_h probs_hplus_microstate::h(std::pair<Iterator, Iterator> i)
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::hl(const TUSubsequence & p_lb, const TUSubsequence & p_region, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::il(const TUSubsequence & p_lb, const TUSubsequence & p_lregion, const std::pair<Rope, std::pair<mfecovar, double> > & p_e, const TUSubsequence & p_rregion, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  TUSubsequence l_1 = p_lregion;
  Rope l_2 = p_e.first;
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::incl(const std::pair<Rope, std::pair<mfecovar, double> > & p_e)
{
  Rope l_0 = p_e.first;
  std::pair<mfecovar, double>  r_0 = p_e.second;
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::ml(const TUSubsequence & p_lb, const std::pair<Rope, std::pair<mfecovar, double> > & p_e, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  Rope l_1 = p_e.first;
  TUSubsequence l_2 = p_rb;
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::mldl(const TUSubsequence & p_lb, const TUSubsequence & p_dl, const std::pair<Rope, std::pair<mfecovar, double> > & p_e, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::mldlr(const TUSubsequence & p_lb, const TUSubsequence & p_dl, const std::pair<Rope, std::pair<mfecovar, double> > & p_e, const TUSubsequence & p_dr, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  TUSubsequence l_1 = p_dl;
  Rope l_2 = p_e.first;
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::mldr(const TUSubsequence & p_lb, const std::pair<Rope, std::pair<mfecovar, double> > & p_e, const TUSubsequence & p_dr, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  Rope l_1 = p_e.first;
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::nil(const TUSubsequence & p_loc)
{
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::sadd(const TUSubsequence & p_b, const std::pair<Rope, std::pair<mfecovar, double> > & p_e)
{
...
std::pair<Rope, std::pair<mfecovar, double> >  probs_hplus_microstate::sr(const TUSubsequence & p_lb, const std::pair<Rope, std::pair<mfecovar, double> > & p_e, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  Rope l_1 = p_e.first;
  TUSubsequence l_2 = p_rb;
...
Rope probs_hplus_microstate::addss_l(const Rope & e, const TUSubsequence & rb)
{
#line 1050 "../../../ali_microstate.gap"
  return e;
#line 1634 "probs_hplus_microstate.cc"
}

Rope probs_hplus_microstate::bl_l(const TUSubsequence & lb, const TUSubsequence & lregion, const Rope & e, const TUSubsequence & rb)
{
#line 1002 "../../../ali_microstate.gap"
  return e;
#line 1641 "probs_hplus_microstate.cc"
}

Rope probs_hplus_microstate::br_l(const TUSubsequence & lb, const Rope & e, const TUSubsequence & rregion, const TUSubsequence & rb)
{
#line 1006 "../../../ali_microstate.gap"
  return e;
#line 1648 "probs_hplus_microstate.cc"
}

Rope probs_hplus_microstate::cadd_l(const Rope & le, const Rope & re)
{
...
#line 1664 "probs_hplus_microstate.cc"
}

Rope probs_hplus_microstate::drem_l(const TUSubsequence & lloc, const Rope & e, const TUSubsequence & rloc)
{
#line 983 "../../../ali_microstate.gap"
  return e;
#line 1671 "probs_hplus_microstate.cc"
}

Rope probs_hplus_microstate::edl_l(const TUSubsequence & lb, const Rope & e, const TUSubsequence & rloc)
{
#line 971 "../../../ali_microstate.gap"
  return e;
#line 1678 "probs_hplus_microstate.cc"
}

Rope probs_hplus_microstate::edlr_l(const TUSubsequence & lb, const Rope & e, const TUSubsequence & rb)
{
#line 979 "../../../ali_microstate.gap"
  return e;
#line 1685 "probs_hplus_microstate.cc"
}

Rope probs_hplus_microstate::edr_l(const TUSubsequence & lloc, const Rope & e, const TUSubsequence & rb)
{
#line 975 "../../../ali_microstate.gap"
  return e;
#line 1692 "probs_hplus_microstate.cc"
}

Rope probs_hplus_microstate::hl_l(const TUSubsequence & lb, const TUSubsequence & region, const TUSubsequence & rb)
{
  Rope res;
  int pos;
  pos = ( ( ((lb.i + rb.j) + 1) )  / 2);
...
Rope probs_hplus_microstate::il_l(const TUSubsequence & lb, const TUSubsequence & lregion, const Rope & e, const TUSubsequence & rregion, const TUSubsequence & rb)
{
#line 1010 "../../../ali_microstate.gap"
  return e;
#line 1719 "probs_hplus_microstate.cc"
}

Rope probs_hplus_microstate::incl_l(const Rope & e)
{
#line 1062 "../../../ali_microstate.gap"
  return e;
#line 1726 "probs_hplus_microstate.cc"
}

Rope probs_hplus_microstate::ml_l(const TUSubsequence & lb, const Rope & e, const TUSubsequence & rb)
{
#line 1208 "../../../ali_microstate.gap"
  Rope res;
  append( res, "(,", 2);
  append( res, e);
  append( res, "),", 2);
  return res;
#line 1737 "probs_hplus_microstate.cc"
}

Rope probs_hplus_microstate::mldl_l(const TUSubsequence & lb, const TUSubsequence & dl, const Rope & e, const TUSubsequence & rb)
{
#line 1264 "../../../ali_microstate.gap"
  Rope res;
  append( res, "(,", 2);
  append( res, e);
  append( res, "),", 2);
  return res;
#line 1748 "probs_hplus_microstate.cc"
}

Rope probs_hplus_microstate::mldlr_l(const TUSubsequence & lb, const TUSubsequence & dl, const Rope & e, const TUSubsequence & dr, const TUSubsequence & rb)
{
#line 1232 "../../../ali_microstate.gap"
  Rope res;
  append( res, "(,", 2);
  append( res, e);
  append( res, "),", 2);
  return res;
#line 1759 "probs_hplus_microstate.cc"
}

Rope probs_hplus_microstate::mldr_l(const TUSubsequence & lb, const Rope & e, const TUSubsequence & dr, const TUSubsequence & rb)
{
#line 1216 "../../../ali_microstate.gap"
  Rope res;
  append( res, "(,", 2);
  append( res, e);
  append( res, "),", 2);
  return res;
#line 1770 "probs_hplus_microstate.cc"
}

Rope probs_hplus_microstate::nil_l(const TUSubsequence & loc)
{
  Rope r;
  return r;
}

Rope probs_hplus_microstate::sadd_l(const TUSubsequence & b, const Rope & e)
{
  Rope emptyShape;
  Rope res;
  if ((e == emptyShape))
...
Rope probs_hplus_microstate::sr_l(const TUSubsequence & lb, const Rope & e, const TUSubsequence & rb)
{
#line 987 "../../../ali_microstate.gap"
  return e;
#line 1801 "probs_hplus_microstate.cc"
}



std::pair<mfecovar, double>  probs_hplus_microstate::addss_r(const std::pair<mfecovar, double> & p_x, const TUSubsequence & p_r)
{
...
std::pair<mfecovar, double>  probs_hplus_microstate::bl_r(const TUSubsequence & p_lb, const TUSubsequence & p_lr, const std::pair<mfecovar, double> & p_x, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
...
std::pair<mfecovar, double>  probs_hplus_microstate::br_r(const TUSubsequence & p_lb, const std::pair<mfecovar, double> & p_x, const TUSubsequence & p_rr, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
...
std::pair<mfecovar, double>  probs_hplus_microstate::cadd_r(const std::pair<mfecovar, double> & p_x, const std::pair<mfecovar, double> & p_y)
{
  mfecovar l_0 = p_x.first;
...
std::pair<mfecovar, double>  probs_hplus_microstate::drem_r(const TUSubsequence & p_lb, const std::pair<mfecovar, double> & p_x, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  mfecovar l_1 = p_x.first;
  TUSubsequence l_2 = p_rb;
...
std::pair<mfecovar, double>  probs_hplus_microstate::edl_r(const TUSubsequence & p_ldangle, const std::pair<mfecovar, double> & p_x, const TUSubsequence & p_rb)
{
...
std::pair<mfecovar, double>  probs_hplus_microstate::edlr_r(const TUSubsequence & p_ldangle, const std::pair<mfecovar, double> & p_x, const TUSubsequence & p_rdangle)
{
  TUSubsequence l_0 = p_ldangle;
  mfecovar l_1 = p_x.first;
...
std::pair<mfecovar, double>  probs_hplus_microstate::edr_r(const TUSubsequence & p_lb, const std::pair<mfecovar, double> & p_x, const TUSubsequence & p_rdangle)
{
  TUSubsequence l_0 = p_lb;
  mfecovar l_1 = p_x.first;
  TUSubsequence l_2 = p_rdangle;
...
std::pair<mfecovar, double>  probs_hplus_microstate::hl_r(const TUSubsequence & p_lb, const TUSubsequence & p_r, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  TUSubsequence l_1 = p_r;
  TUSubsequence l_2 = p_rb;
...
std::pair<mfecovar, double>  probs_hplus_microstate::il_r(const TUSubsequence & p_lb, const TUSubsequence & p_lr, const std::pair<mfecovar, double> & p_x, const TUSubsequence & p_rr, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  TUSubsequence l_1 = p_lr;
  mfecovar l_2 = p_x.first;
...
std::pair<mfecovar, double>  probs_hplus_microstate::incl_r(const std::pair<mfecovar, double> & p_x)
{
  mfecovar l_0 = p_x.first;
  double r_0 = p_x.second;
...
std::pair<mfecovar, double>  probs_hplus_microstate::ml_r(const TUSubsequence & p_lb, const std::pair<mfecovar, double> & p_x, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  mfecovar l_1 = p_x.first;
  TUSubsequence l_2 = p_rb;
...
std::pair<mfecovar, double>  probs_hplus_microstate::mldl_r(const TUSubsequence & p_lb, const TUSubsequence & p_dl, const std::pair<mfecovar, double> & p_x, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  TUSubsequence l_1 = p_dl;
  mfecovar l_2 = p_x.first;
...
std::pair<mfecovar, double>  probs_hplus_microstate::mldlr_r(const TUSubsequence & p_lb, const TUSubsequence & p_dl, const std::pair<mfecovar, double> & p_x, const TUSubsequence & p_dr, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  TUSubsequence l_1 = p_dl;
  mfecovar l_2 = p_x.first;
...
std::pair<mfecovar, double>  probs_hplus_microstate::mldr_r(const TUSubsequence & p_lb, const std::pair<mfecovar, double> & p_x, const TUSubsequence & p_dr, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  mfecovar l_1 = p_x.first;
  TUSubsequence l_2 = p_dr;
...
std::pair<mfecovar, double>  probs_hplus_microstate::nil_r(const TUSubsequence & p_n)
{
...
std::pair<mfecovar, double>  probs_hplus_microstate::sadd_r(const TUSubsequence & p_lb, const std::pair<mfecovar, double> & p_x)
{
  TUSubsequence l_0 = p_lb;
  mfecovar l_1 = p_x.first;
  TUSubsequence r_0 = p_lb;
...
std::pair<mfecovar, double>  probs_hplus_microstate::sr_r(const TUSubsequence & p_lb, const std::pair<mfecovar, double> & p_x, const TUSubsequence & p_rb)
{
  TUSubsequence l_0 = p_lb;
  mfecovar l_1 = p_x.first;
  TUSubsequence l_2 = p_rb;
...
mfecovar probs_hplus_microstate::addss_r_l(const mfecovar & x, const TUSubsequence & r)
{
#line 2229 "../../../ali_microstate.gap"
  mfecovar res = x;
  res.mfe = (res.mfe +  ( (ss_energy(r) / float(rows(r))) ) );
  return res;
#line 2104 "probs_hplus_microstate.cc"
}

mfecovar probs_hplus_microstate::bl_r_l(const TUSubsequence & lb, const TUSubsequence & lr, const mfecovar & x, const TUSubsequence & rb)
{
#line 2165 "../../../ali_microstate.gap"
  ...
  return res;
#line 2114 "probs_hplus_microstate.cc"
}

mfecovar probs_hplus_microstate::br_r_l(const TUSubsequence & lb, const mfecovar & x, const TUSubsequence & rr, const TUSubsequence & rb)
{
#line 2173 "../../../ali_microstate.gap"
  ...
  res.covar = (res.covar + covscore(lb, lb.i, rb.i));
  return res;
#line 2124 "probs_hplus_microstate.cc"
}

mfecovar probs_hplus_microstate::cadd_r_l(const mfecovar & x, const mfecovar & y)
{
#line 2110 "../../../ali_microstate.gap"
  return  ( (x + y) ) ;
#line 2131 "probs_hplus_microstate.cc"
}

mfecovar probs_hplus_microstate::drem_r_l(const TUSubsequence & lb, const mfecovar & x, const TUSubsequence & rb)
{
#line 2142 "../../../ali_microstate.gap"
  mfecovar res = x;
  res.mfe = (res.mfe +  ( (termau_energy(lb, rb) / float(rows(lb))) ) );
  return res;
#line 2140 "probs_hplus_microstate.cc"
}

mfecovar probs_hplus_microstate::edl_r_l(const TUSubsequence & ldangle, const mfecovar & x, const TUSubsequence & rb)
{
#line 2113 "../../../ali_microstate.gap"
  ...
  return res;
#line 2151 "probs_hplus_microstate.cc"
}

mfecovar probs_hplus_microstate::edlr_r_l(const TUSubsequence & ldangle, const mfecovar & x, const TUSubsequence & rdangle)
{
#line 2131 "../../../ali_microstate.gap"
  ...
  return res;
#line 2164 "probs_hplus_microstate.cc"
}

mfecovar probs_hplus_microstate::edr_r_l(const TUSubsequence & lb, const mfecovar & x, const TUSubsequence & rdangle)
{
#line 2122 "../../../ali_microstate.gap"
  ...
  return res;
#line 2175 "probs_hplus_microstate.cc"
}

mfecovar probs_hplus_microstate::hl_r_l(const TUSubsequence & lb, const TUSubsequence & r, const TUSubsequence & rb)
{
#line 2157 "../../../ali_microstate.gap"
  ...
  return res;
#line 2185 "probs_hplus_microstate.cc"
}

mfecovar probs_hplus_microstate::il_r_l(const TUSubsequence & lb, const TUSubsequence & lr, const mfecovar & x, const TUSubsequence & rr, const TUSubsequence & rb)
{
#line 2181 "../../../ali_microstate.gap"
  ...
  res.covar = (res.covar + covscore(lb, lb.i, rb.i));
  return res;
#line 2195 "probs_hplus_microstate.cc"
}

mfecovar probs_hplus_microstate::incl_r_l(const mfecovar & x)
{
#line 2222 "../../../ali_microstate.gap"
  mfecovar res = x;
  res.mfe = (res.mfe + ul_energy());
  return res;
#line 2204 "probs_hplus_microstate.cc"
}

mfecovar probs_hplus_microstate::ml_r_l(const TUSubsequence & lb, const mfecovar & x, const TUSubsequence & rb)
{
#line 2214 "../../../ali_microstate.gap"
  ...
  res.covar = (res.covar + covscore(lb, lb.i, rb.i));
  return res;
#line 2214 "probs_hplus_microstate.cc"
}

mfecovar probs_hplus_microstate::mldl_r_l(const TUSubsequence & lb, const TUSubsequence & dl, const mfecovar & x, const TUSubsequence & rb)
{
#line 2190 "../../../ali_microstate.gap"
  ...
  res.covar = (res.covar + covscore(lb, lb.i, rb.i));
  return res;
#line 2224 "probs_hplus_microstate.cc"
}

mfecovar probs_hplus_microstate::mldlr_r_l(const TUSubsequence & lb, const TUSubsequence & dl, const mfecovar & x, const TUSubsequence & dr, const TUSubsequence & rb)
{
#line 2206 "../../../ali_microstate.gap"
  ...
  res.covar = (res.covar + covscore(lb, lb.i, rb.i));
  return res;
#line 2234 "probs_hplus_microstate.cc"
}

mfecovar probs_hplus_microstate::mldr_r_l(const TUSubsequence & lb, const mfecovar & x, const TUSubsequence & dr, const TUSubsequence & rb)
{
#line 2198 "../../../ali_microstate.gap"
  ...
  res.covar = (res.covar + covscore(lb, lb.i, rb.i));
  return res;
#line 2244 "probs_hplus_microstate.cc"
}

mfecovar probs_hplus_microstate::nil_r_l(const TUSubsequence & n)
{
#line 2236 "../../../ali_microstate.gap"
  ...
  res.covar = 0;
  return res;
#line 2254 "probs_hplus_microstate.cc"
}

mfecovar probs_hplus_microstate::sadd_r_l(const TUSubsequence & lb, const mfecovar & x)
{
#line 2097 "../../../ali_microstate.gap"
  ...
  return res;
#line 2273 "probs_hplus_microstate.cc"
}

mfecovar probs_hplus_microstate::sr_r_l(const TUSubsequence & lb, const mfecovar & x, const TUSubsequence & rb)
{
#line 2149 "../../../ali_microstate.gap"
  ...
  res.covar = (res.covar + covscore(lb, lb.i, rb.i));
  return res;
#line 2283 "probs_hplus_microstate.cc"
}



double probs_hplus_microstate::addss_r_r(double x, const TUSubsequence & r)
{
#line 1800 "../../../ali_microstate.gap"
  return ((x * scale((r.j - r.i))) * mk_pf((ss_energy(r) / float(rows(r)))));
#line 2292 "probs_hplus_microstate.cc"
}

double probs_hplus_microstate::bl_r_r(const TUSubsequence & lb, const TUSubsequence & lr, double x, const TUSubsequence & rb)
{
#line 1775 "../../../ali_microstate.gap"
  return ((x * scale(((2 + lr.j) - lr.i))) * mk_pf(((bl_energy(lr, rb) / float(rows(lb))) + covscore(lb, lb.i, rb.i))));
#line 2299 "probs_hplus_microstate.cc"
}

double probs_hplus_microstate::br_r_r(const TUSubsequence & lb, double x, const TUSubsequence & rr, const TUSubsequence & rb)
{
#line 1778 "../../../ali_microstate.gap"
  return ((x * scale(((2 + rr.j) - rr.i))) * mk_pf(((br_energy(lb, rr) / float(rows(lb))) + covscore(lb, lb.i, rb.i))));
#line 2306 "probs_hplus_microstate.cc"
}

double probs_hplus_microstate::cadd_r_r(double x, double y)
{
#line 1743 "../../../ali_microstate.gap"
  return (x * y);
#line 2313 "probs_hplus_microstate.cc"
}

double probs_hplus_microstate::drem_r_r(const TUSubsequence & lb, double x, const TUSubsequence & rb)
{
#line 1766 "../../../ali_microstate.gap"
  return (x * mk_pf((termau_energy(lb, rb) / float(rows(lb)))));
#line 2320 "probs_hplus_microstate.cc"
}

double probs_hplus_microstate::edl_r_r(const TUSubsequence & ldangle, double x, const TUSubsequence & rb)
{
#line 1746 "../../../ali_microstate.gap"
  TUSubsequence lb = ldangle;
  lb.i = (ldangle.i + 1);
  return ((x * scale(1)) * mk_pf(( ( (termau_energy(lb, rb) + dl_energy(lb, rb)) )  / float(rows(ldangle)))));
#line 2329 "probs_hplus_microstate.cc"
}

double probs_hplus_microstate::edlr_r_r(const TUSubsequence & ldangle, double x, const TUSubsequence & rdangle)
{
...
#line 2340 "probs_hplus_microstate.cc"
}

double probs_hplus_microstate::edr_r_r(const TUSubsequence & lb, double x, const TUSubsequence & rdangle)
{
#line 1752 "../../../ali_microstate.gap"
  TUSubsequence rb = rdangle;
  rb.j = (rdangle.j - 1);
  return ((x * scale(1)) * mk_pf(( ( (termau_energy(lb, rb) + dr_energy(lb, rb)) )  / float(rows(lb)))));
#line 2349 "probs_hplus_microstate.cc"
}

double probs_hplus_microstate::hl_r_r(const TUSubsequence & lb, const TUSubsequence & r, const TUSubsequence & rb)
{
#line 1772 "../../../ali_microstate.gap"
  return (scale(((2 + r.j) - r.i)) * mk_pf((int((hl_energy(r) / float(rows(r)))) + covscore(lb, lb.i, rb.i))));
#line 2356 "probs_hplus_microstate.cc"
}

double probs_hplus_microstate::il_r_r(const TUSubsequence & lb, const TUSubsequence & lr, double x, const TUSubsequence & rr, const TUSubsequence & rb)
{
...
#line 2363 "probs_hplus_microstate.cc"
}

double probs_hplus_microstate::incl_r_r(double x)
{
#line 1797 "../../../ali_microstate.gap"
  return (x * mk_pf(ul_energy()));
#line 2370 "probs_hplus_microstate.cc"
}

double probs_hplus_microstate::ml_r_r(const TUSubsequence & lb, double x, const TUSubsequence & rb)
{
...
#line 2377 "probs_hplus_microstate.cc"
}

double probs_hplus_microstate::mldl_r_r(const TUSubsequence & lb, const TUSubsequence & dl, double x, const TUSubsequence & rb)
{
...
#line 2384 "probs_hplus_microstate.cc"
}

double probs_hplus_microstate::mldlr_r_r(const TUSubsequence & lb, const TUSubsequence & dl, double x, const TUSubsequence & dr, const TUSubsequence & rb)
{
...
#line 2391 "probs_hplus_microstate.cc"
}

double probs_hplus_microstate::mldr_r_r(const TUSubsequence & lb, double x, const TUSubsequence & dr, const TUSubsequence & rb)
{
...
#line 2398 "probs_hplus_microstate.cc"
}

double probs_hplus_microstate::nil_r_r(const TUSubsequence & n)
{
#line 1803 "../../../ali_microstate.gap"
  return 1.000000e+00;
#line 2405 "probs_hplus_microstate.cc"
}

double probs_hplus_microstate::sadd_r_r(const TUSubsequence & lb, double x)
{
...
#line 2422 "probs_hplus_microstate.cc"
}

double probs_hplus_microstate::sr_r_r(const TUSubsequence & lb, double x, const TUSubsequence & rb)
{
#line 1769 "../../../ali_microstate.gap"
  return ((x * scale(2)) * mk_pf((int((sr_energy(lb, rb) / float(rows(lb)))) + covscore(lb, lb.i, rb.i))));
#line 2429 "probs_hplus_microstate.cc"
}


    void probs_hplus_microstate::cyk()
{
...
List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > probs_hplus_microstate::bt_proxy_nt_struct(unsigned int t_0_i)
{
  List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > l;
  empty(l);
  probs_hplus_microstate_hash_h ret = nt_struct(t_0_i);
  if (isEmpty(ret))
    {
      return l;
    }

  intrusive_ptr<Backtrace_nt_struct_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int>  >  bt = new Backtrace_nt_struct_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int> (this, t_0_i);
  for (probs_hplus_microstate_hash_h::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
...
List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > probs_hplus_microstate::bt_proxy_nt_dangle(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > l;
  empty(l);
  probs_hplus_microstate_hash_h ret = nt_dangle(t_0_i, t_0_j);
  if (isEmpty(ret))
    {
      return l;
    }

  intrusive_ptr<Backtrace_nt_dangle_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int>  >  bt = new Backtrace_nt_dangle_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int> (this, t_0_i, t_0_j);
  for (probs_hplus_microstate_hash_h::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    std::pair<Rope, std::pair<mfecovar, double> >  elem = *elem_itr;
    std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > probs_hplus_microstate::bt_proxy_nt_strong(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > l;
  empty(l);
  probs_hplus_microstate_hash_h ret = nt_strong(t_0_i, t_0_j);
  if (isEmpty(ret))
    {
      return l;
    }

  intrusive_ptr<Backtrace_nt_strong_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int>  >  bt = new Backtrace_nt_strong_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int> (this, t_0_i, t_0_j);
  for (probs_hplus_microstate_hash_h::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    std::pair<Rope, std::pair<mfecovar, double> >  elem = *elem_itr;
    std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > probs_hplus_microstate::bt_proxy_nt_weak(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > l;
  empty(l);
  probs_hplus_microstate_hash_h ret = nt_weak(t_0_i, t_0_j);
  if (isEmpty(ret))
    {
      return l;
    }

  intrusive_ptr<Backtrace_nt_weak_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int>  >  bt = new Backtrace_nt_weak_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int> (this, t_0_i, t_0_j);
  for (probs_hplus_microstate_hash_h::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    std::pair<Rope, std::pair<mfecovar, double> >  elem = *elem_itr;
    std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > probs_hplus_microstate::bt_proxy_nt_stack(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > l;
  empty(l);
  probs_hplus_microstate_hash_h ret = nt_stack(t_0_i, t_0_j);
  if (isEmpty(ret))
    {
      return l;
    }

  intrusive_ptr<Backtrace_nt_stack_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int>  >  bt = new Backtrace_nt_stack_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int> (this, t_0_i, t_0_j);
  for (probs_hplus_microstate_hash_h::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    std::pair<Rope, std::pair<mfecovar, double> >  elem = *elem_itr;
    std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::bt_proxy_nt_hairpin(unsigned int t_0_i, unsigned int t_0_j)
{
  std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  l;
  probs_hplus_microstate_hash_h ret = nt_hairpin(t_0_i, t_0_j);
  if (isEmpty(ret))
  {
    empty( l);
    return l;
  ...
  intrusive_ptr<Backtrace_nt_hairpin_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int>  >  bt = new Backtrace_nt_hairpin_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int> (this, t_0_i, t_0_j);
  for (probs_hplus_microstate_hash_h::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    std::pair<Rope, std::pair<mfecovar, double> >  elem = *elem_itr;
    l.first = elem;
...
List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > probs_hplus_microstate::bt_proxy_nt_leftB(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > l;
  empty(l);
  probs_hplus_microstate_hash_h ret = nt_leftB(t_0_i, t_0_j);
  if (isEmpty(ret))
    {
      return l;
    }

  intrusive_ptr<Backtrace_nt_leftB_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int>  >  bt = new Backtrace_nt_leftB_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int> (this, t_0_i, t_0_j);
  for (probs_hplus_microstate_hash_h::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    std::pair<Rope, std::pair<mfecovar, double> >  elem = *elem_itr;
    std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > probs_hplus_microstate::bt_proxy_nt_rightB(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > l;
  empty(l);
  probs_hplus_microstate_hash_h ret = nt_rightB(t_0_i, t_0_j);
  if (isEmpty(ret))
    {
      return l;
    }

  intrusive_ptr<Backtrace_nt_rightB_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int>  >  bt = new Backtrace_nt_rightB_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int> (this, t_0_i, t_0_j);
  for (probs_hplus_microstate_hash_h::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    std::pair<Rope, std::pair<mfecovar, double> >  elem = *elem_itr;
    std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > probs_hplus_microstate::bt_proxy_nt_iloop(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > l;
  empty(l);
  probs_hplus_microstate_hash_h ret = nt_iloop(t_0_i, t_0_j);
  if (isEmpty(ret))
    {
      return l;
    }

  intrusive_ptr<Backtrace_nt_iloop_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int>  >  bt = new Backtrace_nt_iloop_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int> (this, t_0_i, t_0_j);
  for (probs_hplus_microstate_hash_h::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    std::pair<Rope, std::pair<mfecovar, double> >  elem = *elem_itr;
    std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > probs_hplus_microstate::bt_proxy_nt_multiloop(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > l;
  empty(l);
  probs_hplus_microstate_hash_h ret = nt_multiloop(t_0_i, t_0_j);
  if (isEmpty(ret))
    {
      return l;
    }

  intrusive_ptr<Backtrace_nt_multiloop_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int>  >  bt = new Backtrace_nt_multiloop_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int> (this, t_0_i, t_0_j);
  for (probs_hplus_microstate_hash_h::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    std::pair<Rope, std::pair<mfecovar, double> >  elem = *elem_itr;
    std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > probs_hplus_microstate::bt_proxy_nt_ml_comps(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > l;
  empty(l);
  probs_hplus_microstate_hash_h ret = nt_ml_comps(t_0_i, t_0_j);
  if (isEmpty(ret))
    {
      return l;
    }

  intrusive_ptr<Backtrace_nt_ml_comps_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int>  >  bt = new Backtrace_nt_ml_comps_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int> (this, t_0_i, t_0_j);
  for (probs_hplus_microstate_hash_h::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    std::pair<Rope, std::pair<mfecovar, double> >  elem = *elem_itr;
    std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > probs_hplus_microstate::bt_proxy_nt_ml_comps1(unsigned int t_0_i, unsigned int t_0_j)
{
  List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > l;
  empty(l);
  probs_hplus_microstate_hash_h ret = nt_ml_comps1(t_0_i, t_0_j);
  if (isEmpty(ret))
    {
      return l;
    }

  intrusive_ptr<Backtrace_nt_ml_comps1_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int>  >  bt = new Backtrace_nt_ml_comps1_Back<probs_hplus_microstate, std::pair<String, double> , unsigned int> (this, t_0_i, t_0_j);
  for (probs_hplus_microstate_hash_h::iterator elem_itr = ret.ref().begin(); elem_itr!=ret.ref().end(); ++elem_itr){
    std::pair<Rope, std::pair<mfecovar, double> >  elem = *elem_itr;
    std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  tupel;
    tupel.first = elem;
...
intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::bt_nt_dangle(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!dangle_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::bt_nt_hairpin(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 5))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::bt_nt_iloop(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!iloop_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::bt_nt_leftB(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 8))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::bt_nt_ml_comps(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!ml_comps_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::bt_nt_ml_comps1(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!ml_comps1_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::bt_nt_multiloop(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 12))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::bt_nt_rightB(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 8))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::bt_nt_stack(unsigned int t_0_i, unsigned int t_0_j)
{
  if (((t_0_j - t_0_i) < 7))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::bt_nt_strong(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!strong_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::bt_nt_struct(unsigned int t_0_i)
{
  if (!struct_table.is_tabulated(t_0_i))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::bt_nt_weak(unsigned int t_0_i, unsigned int t_0_j)
{
  if (!weak_table.is_tabulated(t_0_i, t_0_j))
    {
      return 0;
...
intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::addss_bt_r(intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  param_0, const TUSubsequence & param_1)
{
  return new Backtrace_addss<std::pair<String, double> , unsigned int> (param_0, param_1);
}

intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::bl_bt_r(const TUSubsequence & param_0, const TUSubsequence & param_1, intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  param_2, const TUSubsequence & param_3)
{
  return new Backtrace_bl<std::pair<String, double> , unsigned int> (param_0, param_1, param_2, param_3);
}

intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::br_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  param_1, const TUSubsequence & param_2, const TUSubsequence & param_3)
{
  return new Backtrace_br<std::pair<String, double> , unsigned int> (param_0, param_1, param_2, param_3);
}

intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::cadd_bt_r(intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  param_0, intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  param_1)
{
  return new Backtrace_cadd<std::pair<String, double> , unsigned int> (param_0, param_1);
}

intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::drem_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  param_1, const TUSubsequence & param_2)
{
  return new Backtrace_drem<std::pair<String, double> , unsigned int> (param_0, param_1, param_2);
}

intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::edl_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  param_1, const TUSubsequence & param_2)
{
  return new Backtrace_edl<std::pair<String, double> , unsigned int> (param_0, param_1, param_2);
}

intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::edlr_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  param_1, const TUSubsequence & param_2)
{
  return new Backtrace_edlr<std::pair<String, double> , unsigned int> (param_0, param_1, param_2);
}

intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::edr_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  param_1, const TUSubsequence & param_2)
{
  return new Backtrace_edr<std::pair<String, double> , unsigned int> (param_0, param_1, param_2);
}

List_Ref<intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > probs_hplus_microstate::h_bt_r(List_Ref<intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > param_0)
{
  return param_0;
}

intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::hl_bt_r(const TUSubsequence & param_0, const TUSubsequence & param_1, const TUSubsequence & param_2)
{
  return new Backtrace_hl<std::pair<String, double> , unsigned int> (param_0, param_1, param_2);
}

intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::il_bt_r(const TUSubsequence & param_0, const TUSubsequence & param_1, intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  param_2, const TUSubsequence & param_3, const TUSubsequence & param_4)
{
  return new Backtrace_il<std::pair<String, double> , unsigned int> (param_0, param_1, param_2, param_3, param_4);
}

intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::incl_bt_r(intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  param_0)
{
  return new Backtrace_incl<std::pair<String, double> , unsigned int> (param_0);
}

intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::ml_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  param_1, const TUSubsequence & param_2)
{
  return new Backtrace_ml<std::pair<String, double> , unsigned int> (param_0, param_1, param_2);
}

intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::mldl_bt_r(const TUSubsequence & param_0, const TUSubsequence & param_1, intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  param_2, const TUSubsequence & param_3)
{
  return new Backtrace_mldl<std::pair<String, double> , unsigned int> (param_0, param_1, param_2, param_3);
}

intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::mldlr_bt_r(const TUSubsequence & param_0, const TUSubsequence & param_1, intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  param_2, const TUSubsequence & param_3, const TUSubsequence & param_4)
{
  return new Backtrace_mldlr<std::pair<String, double> , unsigned int> (param_0, param_1, param_2, param_3, param_4);
}

intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::mldr_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  param_1, const TUSubsequence & param_2, const TUSubsequence & param_3)
{
  return new Backtrace_mldr<std::pair<String, double> , unsigned int> (param_0, param_1, param_2, param_3);
}

intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::nil_bt_r(const TUSubsequence & param_0)
{
  return new Backtrace_nil<std::pair<String, double> , unsigned int> (param_0);
}

intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::sadd_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  param_1)
{
  return new Backtrace_sadd<std::pair<String, double> , unsigned int> (param_0, param_1);
}

intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  probs_hplus_microstate::sr_bt_r(const TUSubsequence & param_0, intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  param_1, const TUSubsequence & param_2)
{
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::addss_bt(const std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rb)
{
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::bl_bt(const TUSubsequence & p_p_lb, const TUSubsequence & p_p_lregion, const std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rb)
{
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::br_bt(const TUSubsequence & p_p_lb, const std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rregion, const TUSubsequence & p_p_rb)
{
  TUSubsequence l_0 = p_p_lb;
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::cadd_bt(const std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_le, const std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_re)
{
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::drem_bt(const TUSubsequence & p_p_lloc, const std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rloc)
{
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::edlr_bt(const TUSubsequence & p_p_lb, const std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rb)
{
  TUSubsequence l_0 = p_p_lb;
  std::pair<Rope, std::pair<mfecovar, double> >  l_1 = p_p_e.first;
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::edr_bt(const TUSubsequence & p_p_lloc, const std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rb)
{
  TUSubsequence l_0 = p_p_lloc;
  std::pair<Rope, std::pair<mfecovar, double> >  l_1 = p_p_e.first;
  TUSubsequence l_2 = p_p_rb;
...
List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > probs_hplus_microstate::h_bt(List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > i, probs_hplus_microstate_hash_h &  left_answers)
{
...
template <typename Iterator>
List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > probs_hplus_microstate::h_bt(std::pair<Iterator, Iterator> i, probs_hplus_microstate_hash_h &  left_answers)

{
  ...
  for (probs_hplus_microstate_hash_h::iterator elem = left_answers.ref().begin(); elem!=left_answers.ref().end(); ++elem){
...
List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > probs_hplus_microstate::h_bt(List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > i)
{
  std::pair<List<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > >::iterator, List<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > >::iterator> range = get_range(i);
  return h_bt(range);
}
...
template <typename Iterator>
List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > probs_hplus_microstate::h_bt(std::pair<Iterator, Iterator> i)

{
  ...
  probs_hplus_microstate_hash_h left_answers = h(left);
  if (isEmpty(left_answers))
  {
    List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > temp;
    empty(temp);
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::hl_bt(const TUSubsequence & p_p_lb, const TUSubsequence & p_p_region, const TUSubsequence & p_p_rb)
{
  TUSubsequence l_0 = p_p_lb;
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::il_bt(const TUSubsequence & p_p_lb, const TUSubsequence & p_p_lregion, const std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rregion, const TUSubsequence & p_p_rb)
{
  TUSubsequence l_0 = p_p_lb;
  TUSubsequence l_1 = p_p_lregion;
  std::pair<Rope, std::pair<mfecovar, double> >  l_2 = p_p_e.first;
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::incl_bt(const std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e)
{
  std::pair<Rope, std::pair<mfecovar, double> >  l_0 = p_p_e.first;
  intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> >  r_0 = p_p_e.second;
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::ml_bt(const TUSubsequence & p_p_lb, const std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rb)
{
  TUSubsequence l_0 = p_p_lb;
  std::pair<Rope, std::pair<mfecovar, double> >  l_1 = p_p_e.first;
  TUSubsequence l_2 = p_p_rb;
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::mldl_bt(const TUSubsequence & p_p_lb, const TUSubsequence & p_p_dl, const std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rb)
{
  TUSubsequence l_0 = p_p_lb;
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::mldlr_bt(const TUSubsequence & p_p_lb, const TUSubsequence & p_p_dl, const std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_dr, const TUSubsequence & p_p_rb)
{
  TUSubsequence l_0 = p_p_lb;
  TUSubsequence l_1 = p_p_dl;
  std::pair<Rope, std::pair<mfecovar, double> >  l_2 = p_p_e.first;
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::mldr_bt(const TUSubsequence & p_p_lb, const std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_dr, const TUSubsequence & p_p_rb)
{
  TUSubsequence l_0 = p_p_lb;
  std::pair<Rope, std::pair<mfecovar, double> >  l_1 = p_p_e.first;
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::nil_bt(const TUSubsequence & p_p_loc)
{
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::sadd_bt(const TUSubsequence & p_p_b, const std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e)
{
...
std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  probs_hplus_microstate::sr_bt(const TUSubsequence & p_p_lb, const std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rb)
{
  TUSubsequence l_0 = p_p_lb;
  std::pair<Rope, std::pair<mfecovar, double> >  l_1 = p_p_e.first;
  TUSubsequence l_2 = p_p_rb;
