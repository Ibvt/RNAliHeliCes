...
#ifndef probs_hplus_microstate_hh
#define probs_hplus_microstate_hh
...
class probs_hplus_microstate_insp_hash_h {
public:
...
typedef Hash::Ref<std::pair<Rope, std::pair<mfecovar, double> > , probs_hplus_microstate_insp_hash_h > probs_hplus_microstate_hash_h;


class probs_hplus_microstate {
...
probs_hplus_microstate_hash_h LBRope_firstG_Bmfecovar_firstG_float_secondG_E_secondG_EMhdecl0x2c77ad0_zero;
...
unsigned int t_0_left_most;
unsigned int t_0_right_most;
std::vector<probs_hplus_microstate_hash_h > array;
std::vector<bool> tabulated;
unsigned int t_0_n;
probs_hplus_microstate_hash_h zero;
unsigned int size()
{
...
probs_hplus_microstate_hash_h &  get(unsigned int t_0_i, unsigned int t_0_j)
{
  assert( (t_0_i <= t_0_j));
  assert( (t_0_j <= t_0_n));
  if (((t_0_j - t_0_i) < 5))
...
void set(unsigned int t_0_i, unsigned int t_0_j,  const probs_hplus_microstate_hash_h &  e)
{
  assert( (t_0_i <= t_0_j));
  assert( (t_0_j <= t_0_n));
  if (((t_0_j - t_0_i) < 5))
...
void clear() { tabulated.clear(); }
probs_hplus_microstate_hash_h &  get(unsigned int t_0_i)
{
  unsigned int t_0_j = t_0_n;
  assert( (t_0_i <= t_0_j));
  assert( (t_0_j <= t_0_n));
...
void set(unsigned int t_0_i,  const probs_hplus_microstate_hash_h &  e)
{
  unsigned int t_0_j = t_0_n;
  assert( (t_0_i <= t_0_j));
  assert( (t_0_j <= t_0_n));
...
empty(LBRope_firstG_Bmfecovar_firstG_float_secondG_E_secondG_EMhdecl0x2c77ad0_zero);

t_0_left_most = 0;
t_0_right_most = t_0_seq.size();
probs_hplus_microstate_insp_hash_h::set_k(kbest);
  ...
  private:
    ...
    bool _exact; 
    probs_hplus_microstate_hash_h &  nt_dangle(unsigned int t_0_i, unsigned int t_0_j);
    probs_hplus_microstate_hash_h nt_hairpin(unsigned int t_0_i, unsigned int t_0_j);
    probs_hplus_microstate_hash_h &  nt_iloop(unsigned int t_0_i, unsigned int t_0_j);
    probs_hplus_microstate_hash_h nt_leftB(unsigned int t_0_i, unsigned int t_0_j);
    probs_hplus_microstate_hash_h &  nt_ml_comps(unsigned int t_0_i, unsigned int t_0_j);
    probs_hplus_microstate_hash_h &  nt_ml_comps1(unsigned int t_0_i, unsigned int t_0_j);
    probs_hplus_microstate_hash_h nt_multiloop(unsigned int t_0_i, unsigned int t_0_j);
    probs_hplus_microstate_hash_h nt_rightB(unsigned int t_0_i, unsigned int t_0_j);
    probs_hplus_microstate_hash_h nt_stack(unsigned int t_0_i, unsigned int t_0_j);
    probs_hplus_microstate_hash_h &  nt_strong(unsigned int t_0_i, unsigned int t_0_j);
    probs_hplus_microstate_hash_h &  nt_struct(unsigned int t_0_i);
    probs_hplus_microstate_hash_h &  nt_weak(unsigned int t_0_i, unsigned int t_0_j);
...
template <typename Iterator>
    probs_hplus_microstate_hash_h h(std::pair<Iterator, Iterator> i)
;
 ...
 public:
   probs_hplus_microstate_hash_h &  run()
{
...
{
  intrusive_ptr<Backtrace_nt_struct_Back<probs_hplus_microstate, Value, pos_int> > back;

Backtrace_nt_struct_Front(intrusive_ptr<Backtrace_nt_struct_Back<probs_hplus_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfecovar, double> > , probs_hplus_microstate, Value, pos_int> > t = back;
...
{
  intrusive_ptr<Backtrace_nt_dangle_Back<probs_hplus_microstate, Value, pos_int> > back;

Backtrace_nt_dangle_Front(intrusive_ptr<Backtrace_nt_dangle_Back<probs_hplus_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfecovar, double> > , probs_hplus_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_strong_Back<probs_hplus_microstate, Value, pos_int> > back;

Backtrace_nt_strong_Front(intrusive_ptr<Backtrace_nt_strong_Back<probs_hplus_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfecovar, double> > , probs_hplus_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_weak_Back<probs_hplus_microstate, Value, pos_int> > back;

Backtrace_nt_weak_Front(intrusive_ptr<Backtrace_nt_weak_Back<probs_hplus_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfecovar, double> > , probs_hplus_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_stack_Back<probs_hplus_microstate, Value, pos_int> > back;

Backtrace_nt_stack_Front(intrusive_ptr<Backtrace_nt_stack_Back<probs_hplus_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfecovar, double> > , probs_hplus_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_hairpin_Back<probs_hplus_microstate, Value, pos_int> > back;

Backtrace_nt_hairpin_Front(intrusive_ptr<Backtrace_nt_hairpin_Back<probs_hplus_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfecovar, double> > , probs_hplus_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_leftB_Back<probs_hplus_microstate, Value, pos_int> > back;

Backtrace_nt_leftB_Front(intrusive_ptr<Backtrace_nt_leftB_Back<probs_hplus_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfecovar, double> > , probs_hplus_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_rightB_Back<probs_hplus_microstate, Value, pos_int> > back;

Backtrace_nt_rightB_Front(intrusive_ptr<Backtrace_nt_rightB_Back<probs_hplus_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfecovar, double> > , probs_hplus_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_iloop_Back<probs_hplus_microstate, Value, pos_int> > back;

Backtrace_nt_iloop_Front(intrusive_ptr<Backtrace_nt_iloop_Back<probs_hplus_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfecovar, double> > , probs_hplus_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_multiloop_Back<probs_hplus_microstate, Value, pos_int> > back;

Backtrace_nt_multiloop_Front(intrusive_ptr<Backtrace_nt_multiloop_Back<probs_hplus_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfecovar, double> > , probs_hplus_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_ml_comps_Back<probs_hplus_microstate, Value, pos_int> > back;

Backtrace_nt_ml_comps_Front(intrusive_ptr<Backtrace_nt_ml_comps_Back<probs_hplus_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfecovar, double> > , probs_hplus_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_ml_comps1_Back<probs_hplus_microstate, Value, pos_int> > back;

Backtrace_nt_ml_comps1_Front(intrusive_ptr<Backtrace_nt_ml_comps1_Back<probs_hplus_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, std::pair<mfecovar, double> > , probs_hplus_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
intrusive_ptr<Eval_List<Value> > eval()
{
  ...
  return t->eval();
    ...
    List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > h_bt(List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > i, probs_hplus_microstate_hash_h &  left_answers);
template <typename Iterator>
    List_Ref<std::pair<std::pair<Rope, std::pair<mfecovar, double> > , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > h_bt(std::pair<Iterator, Iterator> i, probs_hplus_microstate_hash_h &  left_answers)
;
...
namespace gapc {
  typedef probs_hplus_microstate hishapehplus_pfx_cls;
  typedef probs_hplus_microstate_hash_h &  hishapehplus_pfx_ret;
}
#endif
