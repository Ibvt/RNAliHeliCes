...
#
#   MakeMaker ARGV: (q[LDDLFLAGS= -shared])
#
...
#     BUILD_REQUIRES => {  }
#     CCFLAGS => q[-D_REENTRANT -D_GNU_SOURCE -DDEBIAN -fno-strict-aliasing -pipe -fstack-protector -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 $(AM_CXXFLAGS) $(CXXFLAGS)]
#     LD => q[${CXX}]
#     LIBS => [q[-lm]]
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/jhuang/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
CCFLAGS = -D_REENTRANT -D_GNU_SOURCE -DDEBIAN -fno-strict-aliasing -pipe -fstack-protector -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 $(AM_CXXFLAGS) $(CXXFLAGS)
OPTIMIZE = -O2 -g
PERLTYPE = 
MPOLLUTE = 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version:            2.1.1.1' >> META_new.yml
...
disttest : distdir
	cd $(DISTVNAME) && $(ABSPERLRUN) Makefile.PL "LDDLFLAGS= -shared"
...
$(FIRST_MAKEFILE) : Makefile.PL $(CONFIGDEP)
	...
	$(PERLRUN) Makefile.PL "LDDLFLAGS= -shared"
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="2.1.1.1">' > $(DISTNAME).ppd
