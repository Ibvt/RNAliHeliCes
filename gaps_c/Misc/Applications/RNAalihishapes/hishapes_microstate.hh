...
#ifndef hishapes_microstate_hh
#define hishapes_microstate_hh
...
class hishapes_microstate_insp_hash_h {
public:
...
typedef Hash::Ref<std::pair<Rope, mfecovar> , hishapes_microstate_insp_hash_h > hishapes_microstate_hash_h;


class hishapes_microstate {
...
hishapes_microstate_hash_h LBRope_firstG_mfecovar_secondG_EMhdecl0x141a130_zero;
...
unsigned int t_0_left_most;
unsigned int t_0_right_most;
std::vector<hishapes_microstate_hash_h > array;
std::vector<bool> tabulated;
unsigned int t_0_n;
hishapes_microstate_hash_h zero;
unsigned int size()
{
...
hishapes_microstate_hash_h &  get(unsigned int t_0_i, unsigned int t_0_j)
{
  assert( (t_0_i <= t_0_j));
  assert( (t_0_j <= t_0_n));
  if (((t_0_j - t_0_i) < 5))
...
void set(unsigned int t_0_i, unsigned int t_0_j,  const hishapes_microstate_hash_h &  e)
{
  assert( (t_0_i <= t_0_j));
  assert( (t_0_j <= t_0_n));
  if (((t_0_j - t_0_i) < 5))
...
void clear() { tabulated.clear(); }
hishapes_microstate_hash_h &  get(unsigned int t_0_i)
{
  unsigned int t_0_j = t_0_n;
  assert( (t_0_i <= t_0_j));
  assert( (t_0_j <= t_0_n));
...
void set(unsigned int t_0_i,  const hishapes_microstate_hash_h &  e)
{
  unsigned int t_0_j = t_0_n;
  assert( (t_0_i <= t_0_j));
  assert( (t_0_j <= t_0_n));
...
empty(LBRope_firstG_mfecovar_secondG_EMhdecl0x141a130_zero);
...
t_0_right_most = t_0_seq.size();
  ...
  private:
    hishapes_microstate_hash_h &  nt_dangle(unsigned int t_0_i, unsigned int t_0_j);
    std::pair<Rope, mfecovar>  nt_hairpin(unsigned int t_0_i, unsigned int t_0_j);
    hishapes_microstate_hash_h &  nt_iloop(unsigned int t_0_i, unsigned int t_0_j);
    hishapes_microstate_hash_h nt_leftB(unsigned int t_0_i, unsigned int t_0_j);
    hishapes_microstate_hash_h &  nt_ml_comps(unsigned int t_0_i, unsigned int t_0_j);
    hishapes_microstate_hash_h &  nt_ml_comps1(unsigned int t_0_i, unsigned int t_0_j);
    hishapes_microstate_hash_h nt_multiloop(unsigned int t_0_i, unsigned int t_0_j);
    hishapes_microstate_hash_h nt_rightB(unsigned int t_0_i, unsigned int t_0_j);
    hishapes_microstate_hash_h nt_stack(unsigned int t_0_i, unsigned int t_0_j);
    hishapes_microstate_hash_h &  nt_strong(unsigned int t_0_i, unsigned int t_0_j);
    hishapes_microstate_hash_h &  nt_struct(unsigned int t_0_i);
    hishapes_microstate_hash_h &  nt_weak(unsigned int t_0_i, unsigned int t_0_j);
...
template <typename Iterator>
    hishapes_microstate_hash_h h(std::pair<Iterator, Iterator> i)
;
 ...
 public:
   hishapes_microstate_hash_h &  run()
{
...
{
  intrusive_ptr<Backtrace_nt_struct_Back<hishapes_microstate, Value, pos_int> > back;

Backtrace_nt_struct_Front(intrusive_ptr<Backtrace_nt_struct_Back<hishapes_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, mfecovar> , hishapes_microstate, Value, pos_int> > t = back;
...
{
  intrusive_ptr<Backtrace_nt_dangle_Back<hishapes_microstate, Value, pos_int> > back;

Backtrace_nt_dangle_Front(intrusive_ptr<Backtrace_nt_dangle_Back<hishapes_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, mfecovar> , hishapes_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_strong_Back<hishapes_microstate, Value, pos_int> > back;

Backtrace_nt_strong_Front(intrusive_ptr<Backtrace_nt_strong_Back<hishapes_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, mfecovar> , hishapes_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_weak_Back<hishapes_microstate, Value, pos_int> > back;

Backtrace_nt_weak_Front(intrusive_ptr<Backtrace_nt_weak_Back<hishapes_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, mfecovar> , hishapes_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_stack_Back<hishapes_microstate, Value, pos_int> > back;

Backtrace_nt_stack_Front(intrusive_ptr<Backtrace_nt_stack_Back<hishapes_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, mfecovar> , hishapes_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_hairpin_Back<hishapes_microstate, Value, pos_int> > back;

Backtrace_nt_hairpin_Front(intrusive_ptr<Backtrace_nt_hairpin_Back<hishapes_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, mfecovar> , hishapes_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_leftB_Back<hishapes_microstate, Value, pos_int> > back;

Backtrace_nt_leftB_Front(intrusive_ptr<Backtrace_nt_leftB_Back<hishapes_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, mfecovar> , hishapes_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_rightB_Back<hishapes_microstate, Value, pos_int> > back;

Backtrace_nt_rightB_Front(intrusive_ptr<Backtrace_nt_rightB_Back<hishapes_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, mfecovar> , hishapes_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_iloop_Back<hishapes_microstate, Value, pos_int> > back;

Backtrace_nt_iloop_Front(intrusive_ptr<Backtrace_nt_iloop_Back<hishapes_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, mfecovar> , hishapes_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_multiloop_Back<hishapes_microstate, Value, pos_int> > back;

Backtrace_nt_multiloop_Front(intrusive_ptr<Backtrace_nt_multiloop_Back<hishapes_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, mfecovar> , hishapes_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_ml_comps_Back<hishapes_microstate, Value, pos_int> > back;

Backtrace_nt_ml_comps_Front(intrusive_ptr<Backtrace_nt_ml_comps_Back<hishapes_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, mfecovar> , hishapes_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
{
  intrusive_ptr<Backtrace_nt_ml_comps1_Back<hishapes_microstate, Value, pos_int> > back;

Backtrace_nt_ml_comps1_Front(intrusive_ptr<Backtrace_nt_ml_comps1_Back<hishapes_microstate, Value, pos_int> > b) : back(b) {}
intrusive_ptr<Backtrace<Value, pos_int> > backtrack()
{
  intrusive_ptr<Backtrace_NT_Back_Base<std::pair<Rope, mfecovar> , hishapes_microstate, Value, pos_int> > t = back;
  return t->backtrack(this->score());
...
intrusive_ptr<Eval_List<Value> > eval()
{
  ...
  return t->eval();
    ...
    List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > bt_proxy_nt_struct(unsigned int t_0_i);
    List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > bt_proxy_nt_dangle(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > bt_proxy_nt_strong(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > bt_proxy_nt_weak(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > bt_proxy_nt_stack(unsigned int t_0_i, unsigned int t_0_j);
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  bt_proxy_nt_hairpin(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > bt_proxy_nt_leftB(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > bt_proxy_nt_rightB(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > bt_proxy_nt_iloop(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > bt_proxy_nt_multiloop(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > bt_proxy_nt_ml_comps(unsigned int t_0_i, unsigned int t_0_j);
    List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > bt_proxy_nt_ml_comps1(unsigned int t_0_i, unsigned int t_0_j);
    ...
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  addss_bt(const std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rb);
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  bl_bt(const TUSubsequence & p_p_lb, const TUSubsequence & p_p_lregion, const std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rb);
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  br_bt(const TUSubsequence & p_p_lb, const std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rregion, const TUSubsequence & p_p_rb);
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  cadd_bt(const std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_le, const std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_re);
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  drem_bt(const TUSubsequence & p_p_lloc, const std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rloc);
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  edl_bt(const TUSubsequence & p_p_lb, const std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rloc);
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  edlr_bt(const TUSubsequence & p_p_lb, const std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rb);
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  edr_bt(const TUSubsequence & p_p_lloc, const std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rb);
    List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > h_bt(List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > i_orig, hishapes_microstate_hash_h &  left_answers);
template <typename Iterator>
    List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > h_bt(std::pair<Iterator, Iterator> i, hishapes_microstate_hash_h &  left_answers)
;
    List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > h_bt(List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > i_orig);
template <typename Iterator>
    List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > h_bt(std::pair<Iterator, Iterator> i)
;
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  hl_bt(const TUSubsequence & p_p_lb, const TUSubsequence & p_p_region, const TUSubsequence & p_p_rb);
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  il_bt(const TUSubsequence & p_p_lb, const TUSubsequence & p_p_lregion, const std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rregion, const TUSubsequence & p_p_rb);
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  incl_bt(const std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e);
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  ml_bt(const TUSubsequence & p_p_lb, const std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rb);
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  mldl_bt(const TUSubsequence & p_p_lb, const TUSubsequence & p_p_dl, const std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rb);
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  mldlr_bt(const TUSubsequence & p_p_lb, const TUSubsequence & p_p_dl, const std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_dr, const TUSubsequence & p_p_rb);
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  mldr_bt(const TUSubsequence & p_p_lb, const std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_dr, const TUSubsequence & p_p_rb);
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  nil_bt(const TUSubsequence & p_p_loc);
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  sadd_bt(const TUSubsequence & p_p_b, const std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e);
    std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > >  sr_bt(const TUSubsequence & p_p_lb, const std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > & p_p_e, const TUSubsequence & p_p_rb);
...
{
List_Ref<std::pair<std::pair<Rope, mfecovar> , intrusive_ptr<Backtrace<std::pair<String, double> , unsigned int> > > > bt  = bt_proxy_nt_struct(t_0_i);
...
namespace gapc {
  typedef hishapes_microstate class_name;
  typedef hishapes_microstate_hash_h &  return_type;
}
#endif
