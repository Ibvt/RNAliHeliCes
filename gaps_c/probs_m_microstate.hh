...
probs_m_microstate_hash_h LBRope_firstG_Bmfecovar_firstG_float_secondG_E_secondG_EMhdecl0x20ae340_zero;
...
empty(LBRope_firstG_Bmfecovar_firstG_float_secondG_E_secondG_EMhdecl0x20ae340_zero);

t_0_left_most = 0;
t_0_right_most = t_0_seq.size();
probs_m_microstate_insp_hash_h::set_k(opts.k);
}
...
namespace gapc {
  typedef probs_m_microstate class_name;
  typedef probs_m_microstate_hash_h &  return_type;
}
#endif
