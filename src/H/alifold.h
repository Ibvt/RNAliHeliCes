...
float   energy_of_alistruct(const char **sequences,
                            ...
                            float *energy);
//ADDED
float energy_of_alistruct2(const char **sequences, const char *structure, int n_seq);
int energy_of_alistruct_pt2(const char **sequences, short *pt, int n_seq);
//float   energy_of_alistruct_pt2(const char **sequences,short * ptable, int n_seq, int *energy);
