...
List_Ref<std::pair<mfecovar, String> > &  eval_microstate::nt_dangle(unsigned int t_0_i, unsigned int t_0_j)
{
  ...
  if (((t_0_j - t_0_i) >= 6))
  {
    ...
    {
      TUSubsequence ret_1;
      if (unpaired_eval(t_0_seq, t_0_i, (t_0_i + 1)))
        {
  ...
  {
    TUSubsequence ret_7;
    if (unpaired_eval(t_0_seq, (t_0_j - 1), t_0_j))
      {
...
std::pair<mfecovar, String>  eval_microstate::nt_hairpin(unsigned int t_0_i, unsigned int t_0_j)
{
  ...
  if (((t_0_j - t_0_i) >= 5))
    {
      if (basepair_eval(t_0_seq, t_0_i, t_0_j))
      {
        ...
        {
          TUSubsequence ret_2;
          if ((minsize(t_0_seq, (t_0_i + 1), (t_0_j - 1), 3) && unpaired_eval(t_0_seq, (t_0_i + 1), (t_0_j - 1))))
            {
      ...
      if (basepair_eval(t_0_seq, t_0_i, t_0_j))
        {
          for(          unsigned int t_0_k_0 = (t_0_i + 2); ((t_0_k_0 <= (t_0_j - 7)) && (t_0_k_0 <= (t_0_i + 31))); ++t_0_k_0)
          {
            for(            unsigned int t_0_k_1 = (((t_0_j - (t_0_k_0 + 5)) >= 31)) ? ((t_0_j - 31)) : ((t_0_k_0 + 5)); (t_0_k_1 <= (t_0_j - 2)); ++t_0_k_1)
            {
              ...
              {
                TUSubsequence ret_4;
                if ((maxsize(t_0_seq, t_0_k_1, (t_0_j - 1), 30) && unpaired_eval(t_0_seq, t_0_k_1, (t_0_j - 1))))
                  {
                ...
                {
                  TUSubsequence ret_2;
                  if ((maxsize(t_0_seq, (t_0_i + 1), t_0_k_0, 30) && unpaired_eval(t_0_seq, (t_0_i + 1), t_0_k_0)))
                    {
  ...
  if (((t_0_j - t_0_i) >= 6))
    {
      for(      unsigned int t_0_k_1 = (t_0_i + 5); (t_0_k_1 <= (t_0_j - 1)); ++t_0_k_1)
      {
        ...
        if (unpaired_eval(t_0_seq, t_0_k_1, t_0_j))
          {
  ...
  if (((t_0_j - t_0_i) >= 13))
    {
      if (basepair_eval(t_0_seq, t_0_i, t_0_j))
      {
        ...
        {
          TUSubsequence ret_6;
          if (unpaired_eval(t_0_seq, (t_0_i + 1), ((t_0_i + 1) + 1)))
            {
  ...
  if (((t_0_j - t_0_i) >= 13))
    {
      if (basepair_eval(t_0_seq, t_0_i, t_0_j))
      {
        ...
        {
          TUSubsequence ret_12;
          if (unpaired_eval(t_0_seq, (t_0_j - 2), (t_0_j - 1)))
            {
      ...
      if (basepair_eval(t_0_seq, t_0_i, t_0_j))
        {
          for(          unsigned int t_0_k_0 = (((t_0_j - (t_0_i + 6)) >= 31)) ? ((t_0_j - 31)) : ((t_0_i + 6)); (t_0_k_0 <= (t_0_j - 2)); ++t_0_k_0)
          {
            ...
            {
              TUSubsequence ret_3;
              if ((maxsize(t_0_seq, t_0_k_0, (t_0_j - 1), 30) && unpaired_eval(t_0_seq, t_0_k_0, (t_0_j - 1))))
                {
