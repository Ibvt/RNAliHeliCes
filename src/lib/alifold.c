...
//ADDED
PUBLIC  float energy_of_alistruct2(const char **sequences, const char *structure, int n_seq/*, float *energy*/){
  int new=0;
  unsigned int s, n;
  short *pt;
  ...
  return ((float)en_struct[0]/(float)(100*n_seq) - (float)en_struct[1]/(float)(100*n_seq));
}

//ADDED
PUBLIC  int energy_of_alistruct_pt2(const char **sequences, short *pt, int n_seq/*, int *energy*/){
  int new=0;
  unsigned int s, n;
  //short *pt;
  ...
  if(sequences[0] != NULL){
    ...
    //free(pt);
    //energy[0] = (float)en_struct[0]/(float)(n_seq);  //100*
    //energy[1] = (float)en_struct[1]/(float)(n_seq);  //100*
  ...
  return (int)((float)en_struct[0]/(float)(n_seq) - (float)en_struct[1]/(float)(n_seq));
}
