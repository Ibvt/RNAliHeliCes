 ...
 *
 * ./RNAalihipath -f ../examples/test4.aln -k 2 -F ../examples/test4.ss
 * 
==30962== HEAP SUMMARY:
==30962==     in use at exit: 631,104 bytes in 4 blocks
==30962==   total heap usage: 44,889 allocs, 44,885 frees, 38,600,548 bytes allocated
==30962== 
==30962== 120 bytes in 1 blocks are still reachable in loss record 1 of 4
==30962==    at 0x4C28B35: operator new(unsigned long) (vg_replace_malloc.c:261)
==30962==    by 0x4E3DF9: Hash::Set<std::pair<rope::Ref<rope::Ref_Count>, std::pair<mfecovar, double> >, probs_a_microstate_insp_hash_h, unsigned int, Hash::Multhash, Hash::Size2pow, Hash::EnableShrink, Hash::NoStats, 75u>::filter() (???:412)
==30962==    by 0x4D3E11: probs_a_microstate::nt_struct(unsigned int) (hashtng.hh:409)
==30962==    by 0x4D3CD5: probs_a_microstate::nt_struct(unsigned int) (probs_a_microstate.cc:1228)
==30962==    by 0x4D3CD5: probs_a_microstate::nt_struct(unsigned int) (probs_a_microstate.cc:1228)
==30962==    by 0x4D3CD5: probs_a_microstate::nt_struct(unsigned int) (probs_a_microstate.cc:1228)
==30962==    by 0x4D3CD5: probs_a_microstate::nt_struct(unsigned int) (probs_a_microstate.cc:1228)
==30962==    by 0x4D3CD5: probs_a_microstate::nt_struct(unsigned int) (probs_a_microstate.cc:1228)
...
==30962==    by 0x4D3CD5: probs_a_microstate::nt_struct(unsigned int) (probs_a_microstate.cc:1228)
==30962== 
==30962== 210,328 bytes in 1 blocks are still reachable in loss record 2 of 4
==30962==    at 0x4C279F2: calloc (vg_replace_malloc.c:467)
==30962==    by 0x4F0B5B: space (utils.c:40)
==30962==    by 0x501ED1: get_scaled_parameters (params.c:50)
==30962==    by 0x5097DE5: librna_read_param_file (rnalib.c:56)
==30962==    by 0x40D203: main (rnaalihipath.cc:362)
==30962== 
==30962== 210,328 bytes in 1 blocks are still reachable in loss record 3 of 4
==30962==    at 0x4C279F2: calloc (vg_replace_malloc.c:467)
==30962==    by 0x4F0B5B: space (utils.c:40)
==30962==    by 0x501ED1: get_scaled_parameters (params.c:50)
==30962==    by 0x4F9E5A: update_fold_params_par (fold.c:1339)
==30962==    by 0x4115DC: find_saddle(char const*, char const*, char const*, int) (rnaalihipath.cc:1491)
==30962==    by 0x411A84: get_path(char const*, char const*, char const*, int) (rnaalihipath.cc:1567)
==30962==    by 0x41933B: hipathPairwise(std::string const&, std::string const&, std::string const&, std::string const&, int, std::vector<std::pair<char const*, unsigned int>, std::allocator<std::pair<char const*, unsigned int> > >&, unsigned int, bool) (rnaalihipath.cc:1424)
==30962==    by 0x40D31A: main (rnaalihipath.cc:475)
==30962== 
==30962== 210,328 bytes in 1 blocks are still reachable in loss record 4 of 4
==30962==    at 0x4C279F2: calloc (vg_replace_malloc.c:467)
==30962==    by 0x4F0B5B: space (utils.c:40)
==30962==    by 0x501ED1: get_scaled_parameters (params.c:50)
==30962==    by 0x502761: scale_parameters (params.c:40)
==30962==    by 0x50B529: update_alifold_params (alifold.c:242)
==30962==    by 0x50E5E8: energy_of_alistruct2 (alifold.c:1579)
==30962==    by 0x411AE2: get_path(char const*, char const*, char const*, int) (rnaalihipath.cc:1579)
==30962==    by 0x41933B: hipathPairwise(std::string const&, std::string const&, std::string const&, std::string const&, int, std::vector<std::pair<char const*, unsigned int>, std::allocator<std::pair<char const*, unsigned int> > >&, unsigned int, bool) (rnaalihipath.cc:1424)
==30962==    by 0x40D31A: main (rnaalihipath.cc:475)
==30962== 
==30962== LEAK SUMMARY:
==30962==    definitely lost: 0 bytes in 0 blocks
==30962==    indirectly lost: 0 bytes in 0 blocks
==30962==      possibly lost: 0 bytes in 0 blocks
==30962==    still reachable: 631,104 bytes in 4 blocks  ==>  ==31118==    still reachable: 753,984 bytes in 10 blocks
==30962==         suppressed: 0 bytes in 0 blocks
==30962== 
==30962== For counts of detected and suppressed errors, rerun with: -v
==30962== Use --track-origins=yes to see where uninitialised values come from
==30962== ERROR SUMMARY: 2550 errors from 9 contexts (suppressed: 4 from 4)
